...
public class PurRqInfoServiceImpl implements PurRqInfoService{
    ...
    private List<Map<String, Object>> makeGetPrRequestSAPReturn(JCoTable jcoTable) {
        ...
        LOGGER.debug("======resultVal======= > : " +resultVal);
        return resultVal;
    };
    ...
    private List<Map<String, Object>> callZ_RFC_PRS04(List<Map<String,Object>> dataList){
        ...
        try {
            ...
            LOGGER.debug("ERROR >> callZ_RFC_PRS04 : Saq Error====="+e.toString());
        } finally {
            return resultVal;
        }
    }
    ...
    private List<Map<String, Object>> callZ_RFC_PRS05(List<Map<String,Object>> dataList){
        ...
        try {
            ...
            LOGGER.debug("ERROR >> callZ_RFC_PRS05 : Saq Error====="+e.toString());
        } finally {
            return resultVal;
        }
    }
    ...
    private String erpApprovalResultSave(JCoTable jcoTable, Map<String, Object> input ) {
        ...
        if (rowCnt > 0) {
            for (int i = 0; i < rowCnt; i++) {
                ...
                map.put("banfnPrs", jcoTable.getString("BANFN_PRS"));
                map.put("bnfpoPrs", jcoTable.getString("BNFPO_PRS"));
   ...
   public List<Map<String, Object>> retrievePurRqInfo(HashMap<String, Object> input){
        return retrieveERPPrInfo(input);
    }
