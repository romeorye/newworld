...
import iris.web.prs.purRq.service.PrsMailService;
...
@Controller
public class PrsMailController  extends IrisBaseController {

	@Resource(name="messageSourceAccessor")
	private MessageSourceAccessor messageSourceAccessor;

	@Resource(name="prsMailService")
	private PrsMailService prsMailService;			// MmMail 서비스
	...
	static final Logger LOGGER = LogManager.getLogger(PrsMailController.class);


	/* 메일 팝업 화면이동 */
	@SuppressWarnings("unchecked")
	@RequestMapping(value="/prs/sendMailPopup.do")
	public String sendMailPopupView(
		...
		LOGGER.debug("#####################################################################################");
		LOGGER.debug("PrsMailController - sendMailPopupView [메일 팝업 화면이동]");
	...
	/** 메일발송 **/
	@RequestMapping(value="/prs/sendMail.do")
	public ModelAndView simpleSendMail(
		...
		LOGGER.debug("################################################################");
		LOGGER.debug("PrsMailController - simpleSendMail [메일보내기]");
	...
	//			mailSender.setText(NullUtil.nvl(input.get("mailText"),""));
			...
			prsMailService.insertMailSndHis(sndMailList);
