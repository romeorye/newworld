...
@Service("mmMailService")
public class MmMailServiceImpl implements MmMailService {

	static final Logger LOGGER = LogManager.getLogger(MmMailServiceImpl.class);
	...
	public void insertMailSndHis(List<HashMap<String, Object>> mailSndList) {
		commonDao.batchInsert("open.mchnEduAnl.insertMailHis", mailSndList);
	}
}