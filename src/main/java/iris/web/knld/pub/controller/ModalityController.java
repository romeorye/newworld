...
public class ModalityController  extends IrisBaseController {
	...
	public ModelAndView insertModalityInfo(
		...
		String modalitySbcHtml = "";
		String modalitySbcHtml_temp = "";
		...
		try
		{
            ...
            modalitySbcHtml = mime.getBodyContent();
            modalitySbcHtml_temp = CommonUtil.replaceSecOutput(CommonUtil.replace(CommonUtil.replace(modalitySbcHtml, "<", "@![!@"),">","@!]!@"));
			...
			for(Map<String,Object> modalityRgstDataSetMap : modalityRgstDataSetList) {
				...
				modalityRgstDataSetMap.put("sbcNm" , NullUtil.nvl(modalitySbcHtml, ""));
