...
public class TechnologyController  extends IrisBaseController {
	...
	public ModelAndView insertTechnologyInfo(
		...
		try
		{
            ...
            techSbcHtml = mime.getBodyContent();
            techSbcHtml_temp = CommonUtil.replaceSecOutput(CommonUtil.replace(CommonUtil.replace(techSbcHtml, "<", "@![!@"),">","@!]!@"));
			...
			for(Map<String,Object> techRgstDataSetMap : techRgstDataSetList) {
				...
				techRgstDataSetMap.put("sbcNm" , NullUtil.nvl(techSbcHtml, ""));
