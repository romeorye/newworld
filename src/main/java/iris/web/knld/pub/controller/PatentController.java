...
public class PatentController  extends IrisBaseController {
	...
	public ModelAndView insertPatentInfo(
		...
		String patentSbcHtml = "";
		String patentSbcHtml_temp = "";
		...
		try
		{
            ...
            patentSbcHtml = mime.getBodyContent();
            patentSbcHtml_temp = CommonUtil.replaceSecOutput(CommonUtil.replace(CommonUtil.replace(patentSbcHtml, "<", "@![!@"),">","@!]!@"));
			...
			for(Map<String,Object> patentRgstDataSetMap : patentRgstDataSetList) {
				...
				patentRgstDataSetMap.put("sbcNm" , NullUtil.nvl(patentSbcHtml, ""));
