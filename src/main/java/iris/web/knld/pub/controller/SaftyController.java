...
public class SaftyController  extends IrisBaseController {
	...
	public ModelAndView insertSaftyInfo(
		...
		try
		{
            ...
            saftySbcHtml = mime.getBodyContent();
            saftySbcHtml_temp = CommonUtil.replaceSecOutput(CommonUtil.replace(CommonUtil.replace(saftySbcHtml, "<", "@![!@"),">","@!]!@"));
			...
			for(Map<String,Object> saftyRgstDataSetMap : saftyRgstDataSetList) {
				...
				saftyRgstDataSetMap.put("sbcNm" , NullUtil.nvl(saftySbcHtml, ""));
