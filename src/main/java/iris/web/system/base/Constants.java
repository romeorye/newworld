...
public class Constants {
    ...
    public static final String MSG_INFO_NODELETE = MSG_PREFIX + "inf.com.nodelete";
    
    public static final String MSG_INFO_NOSELET = MSG_PREFIX + "inf.com.noselect";
    ...
    public static final String MSG_CONFIRM_SAVE = MSG_PREFIX + "cfm.com.save";
    
    public static final String MSG_CONFIRM_DELETE = MSG_PREFIX + "cfm.com.delete";
    
    public static final String MSG_CONFIRM_UPDATE = MSG_PREFIX + "cfm.com.update";
    
    public static final String MSG_WARNING_INPUT = MSG_PREFIX + "warn.com.input";
    
    public static final String MSG_WARNING_REQUIRED = MSG_PREFIX + "warn.com.required";
    
    public static final String MSG_WARNING_SELECT = MSG_PREFIX + "warn.com.select";
    
    public static final String MSG_WARNING_RETRIEVE = MSG_PREFIX + "warn.com.retrieve";
    
    public static final String MSG_WARNING_REQUIRED1 = MSG_PREFIX + "warn.com.required1";
    

    //REAL
    public static final String END_POINT = "http://wcc.lghausys.com:9094/p2pd/servlet/dispatch";
    
    public static final String Report_POINT = "http://wcc.lghausys.com:80/ibmcognos/cgi-bin/cognos.cgi";
    
                                               
    //public static final String END_POINT = "http://localhost:9300/p2pd/servlet/dispatch/";
    
    //public static final String Report_POINT = "http://localhost:8090/c10/cgi-bin/cognos.cgi";
    
    public static final String NAME_SPACE = "LGHausys";
