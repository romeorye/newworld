            	...
            	<colgroup>
			     ...
			     <tbody>
			     	<tr>
			            ...
			            <th>WBS Code<span style="color:red;">*</span></th>
			            <td>
							<input type="text" class="" id="posid" name="posid" value="" >&nbsp;<span id="post1" name="post1"></span>
			            </td>
			            <th>납품요청일<span style="color:red;">*</span></th>
			            <td>
			            	<div id="eeind"/>
			            </td>
			        </tr>
			        <tr>
			        	...
			        	<th>납품위치<span style="color:red;">*</span></th>
			            <td>
			            	<select id="position" name="position"></select>
			            </td>
			            <th>구매그룹<span style="color:red;">*</span></th>
			            <td>
					...
					<tr>
			     	...
			     	<tr>
			        	<th>요청품명<span style="color:red;">*</span></th>
			            <td>
