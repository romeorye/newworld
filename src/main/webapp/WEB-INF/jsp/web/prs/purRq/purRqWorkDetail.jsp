...
<script type="text/javascript">
    ...
    Rui.onReady(function() {
        ...
        //거래처전화번호
        var lifnrphone = new Rui.ui.form.LTextBox({                // LTextBox개체를 선언
            applyTo: 'lifnrphone',                               // 해당 DOM Id 위치에 텍스트박스를 적용
            width: 200,                                        // 텍스트박스 폭을 설정
            placeholder: '거래처전화번호',                         // [옵션] 입력 값이 없을 경우 기본 표시 메시지를 설정
            invalidBlur: false                                // [옵션] invalid시 blur를 할 수 있을지 여부를 설정
        });
        ...
        **/
        ...
        var itemColumnModel = new Rui.ui.grid.LColumnModel({
            columns: [
                ...
                , { field: 'lifnrphone',label: '거래처전화번호',sortable: false,    align:'left',    width: 150 }
                 ...
                 <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <th>거래처 전화번호</th>
                        <td>
                            <input type="text" id="lifnrphone" name="lifnrphone" maxlength="35" /> (15자 이내)
                        </td>
