            ...
            *******************/
            ...
            var userColumnModel = new Rui.ui.grid.LColumnModel({
                ...
                <c:if test="${inputData.cnt != 1}">
                    ...
                    , { field : 'deptName',		label : '부서',		sortable : false,	align :'center',	width : (cnt == 1 ? 280 : 260) }
                ]
            });
            ...
            userGrid.on('cellDblClick', function(e) {
            	...
            	<c:if test="${inputData.cnt == 1}">
            		parent._callback(userDataSet.getAt(e.row).data, '${inputData.field}');
        ...
        <c:if test="${inputData.cnt != 1}">
	        ...
	        var selectUserColumnModel = new Rui.ui.grid.LColumnModel({
	            columns : [
	                ...
	                , { field : 'saName',		label : '이름',		sortable : false,	align :'center',	width : 100 }
	                , { field : 'saJobxName',	label : '직위',		sortable : false,	align :'center',	width : 100 }
	                , { field : 'deptName',		label : '부서',		sortable : false,	align :'center',	width : 260 }
	            ]
	        });
   					...
   					<tbody>
   						<tr>
    						...
    						<th align="right">부서</th>
   							<td class="user_search_td">
   								<input type="text" id="deptNm" name="deptNm" value="" />
   							</td>
   							<td class="txt-right">
