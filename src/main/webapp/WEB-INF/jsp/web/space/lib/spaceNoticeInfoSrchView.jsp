...
//RTRV_RQ_DOC_CD rtrvRqDocCd
	...
	var lvAttcFilId ;
		...
		Rui.onReady(function() {
            ...
            <%-- DATASET --%>
            spaceSrchViewDataSet = new Rui.data.LJsonDataSet({
                id: 'spaceSrchViewDataSet',
                remainRemoved: true,
                lazyLoad: true,
                fields: [
		   		      { id: 'bbsId' }       /*게시판ID*/
		   			...
		   			, { id: 'docNo' }       /*문서번호*/
		   			, { id: 'sopNo' }       /*SOP번호*/
		   			, { id: 'spaceTlcgClCd' } /*분석기술정보분류코드*/
		   			, { id: 'spaceTlcgClNm' } /*분석기술정보분류이름*/
		   			, { id: 'qnaClCd' }     /*질문답변구분코드*/
		   			, { id: 'qnaClNm' }     /*질문답변구분이름*/
		   			, { id: 'frstRgstDt'}   /*등록일*/
		   			, { id: 'delYn' }       /*삭제여부*/
            ...
            spaceSrchViewDataSet.on('load', function(e) {
//             	var bbsSbc = spaceSrchViewDataSet.getNameValue(0, "bbsSbc").replaceAll('\n', '<br/>');
//             	spaceSrchViewDataSet.setNameValue(0, 'bbsSbc', bbsSbc);

                lvAttcFilId = spaceSrchViewDataSet.getNameValue(0, "attcFilId");
 ...
 */
            ...
            var spaceLibInfoBind = new Rui.data.LBind({
                ...
                bindInfo: [
                  ...
                  , { id: 'spaceTlcgClNm', ctrlId: 'spaceTlcgClNm',value: 'html' } //분석기술정보분류이름
              ]
            });
            ...
            setAttachFileInfo = function(attachFileList) {
                ...
                if(Rui.isEmpty(lvAttcFilId)) {
                	...
                	spaceSrchViewDataSet.setNameValue(0, "attcFilId", attachFileList[0].data.attcFilId);
                }
            };
	...
	<%--/*******************************************************************************
   	 * FUNCTION 명 : fncDeleteSpaceLibInfo (공지사항 삭제)
   	 ...
   	 *******************************************************************************/--%>
	    fncDeleteSpaceLibInfo = function(){
	    	...
	    	dm1.on('success', function(e) {
				var resultData = spaceSrchViewDataSet.getReadData(e);
	            alert(resultData.records[0].rtnMsg);

	  	    	nwinsActSubmit(document.aform, "<c:url value='/space/lib/retrieveSpaceLibList.do'/>"+"?bbsCd="+bbsCd);
			});
