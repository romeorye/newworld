	...
	Rui.onReady(function() {
        ...
        *******************/
        ...
        tabView.on('activeTabChange', function(e){
        	...
        	case 1:
        		refresh  = true;
        		$('#h2Titl').text('Q&A - 기기분석');

                if(e.isFirst){
                	goPage('tabContentIfrm1', '11');
        	...
        	case 2:
        		refresh  = true;
        		$('#h2Titl').text('Q&A - 신뢰성시험');

                if(e.isFirst){
                	goPage('tabContentIfrm2', '12');
                }else if(refresh==true){
                	goPage('tabContentIfrm2', '12');
        		   	refresh = false;
    		   	}
        	...
        	case 3:
        		refresh  = true;
        		$('#h2Titl').text('Q&A - 공간평가');

                if(e.isFirst){
                	goPage('tabContentIfrm3', '13');
                }else if(refresh==true){
                	goPage('tabContentIfrm3', '13');
        		   	refresh = false;
    		   	}
