	...
	<script type="text/javascript">
		...
		Rui.onReady(function() {
            ...
            addBtn.on('click', function(){
                ...
                var aEl = Rui.createElements(' <button type="button" id="deleteBtn" >삭제</button>');
            		...
            		if ( filePath == "" ) {
            			...
            			if($('#ext').val() != '*') {
                			...
                			if($('#ext').val().indexOf(ext) == -1) {
                				Rui.alert($('#ext').val() + ' 확장자만 첨부할 수 있습니다.');
                    			isValid = false;
                    			return false;
                			}
            			}
	        ...
	        setCallBack = function(){
	        	window.dialogArguments.setAttachFileInfo(getAttachFileInfoList());
   		...
   		<div class="contents pop_in">
   			...
   			<div class="sub-content">
				...
				<div id="attachFileGrid"></div>
   					...
   					<div class="LblockButton">
   						<button type="button" class="btn"  id="appBtn" name="appBtn" onclick="setCallBack();">적용</button>
   						<button type="button" class="btn"  id="closeBtn" name="closeBtn" onclick="window.close();">닫기</button>
   					</div>
