...
/*
 *************************************************************************
 * $Id		: rlabEvaluationMgmtReqPopup.jsp
 * @desc    : 관련시험 리스트 조회 팝업
 *------------------------------------------------------------------------
          ...
          //서버전송용
            ...
            dm.on('success', function(e) {
                ...
                if(data.records[0].resultYn == "Y") {
                	...
                	parent.getRlabRqprOpinitionList(data.records[0].resultMsg);
            ...
            fnSave = function() {
                ...
                Rui.confirm({
                    ...
                    handlerYes: function() {
                        dm.updateDataSet({
                            url:'<c:url value="/rlab/saveRlabRqprOpinition.do"/>',
                            //dataSets:[dataSet]
                            params: {
                            	rqprId : rqprId
                            	, opiId : opiId
          ...
          //삭제
            fnDel = function() {
                ...
                Rui.confirm({
                    ...
                    handlerYes: function() {
                        dm.updateDataSet({
                            url:'<c:url value="/rlab/deleteRlabRqprOpinition.do"/>',
                            //dataSets:[dataSet]
                            params: {
                            	rqprId : rqprId
                            	, opiId : opiId
