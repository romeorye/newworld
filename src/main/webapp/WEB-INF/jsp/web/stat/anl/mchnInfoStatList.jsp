	...
	Rui.onReady(function(){
	    ...
	    var columnModel = new Rui.ui.grid.LColumnModel({
	        ...
	        columns: [
	            ...
	            { field: 'mchnNm',  	label: '분석기기', 		align: 'left', 	 width: 240},
	            { field: 'uperDeptNm',  label: '사업부',		align: 'center', width: 120},
	            { field: 'deptNm',  	label: '팀(PJT)', 		align: 'center', width: 180},
	            { field: 'rgstNm',  	label: '예약자', 		align: 'center', width: 80},
	            { field: 'smpoNm', 		label: '시료명', 		align: 'center', width: 130},
	            { field: 'smpoQty', 	label: '시료수',		align: 'center', width: 50},
