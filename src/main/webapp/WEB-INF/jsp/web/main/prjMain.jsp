...
<style>
.btn_menu #tmpMenu {display:none !important;}
.btn_menu:hover #tmpMenu {display:block !important;}
.btn_menu #tmpMenu
{position: absolute;z-index: 999; text-align:left; position: absolute; z-index:999;width:950px; background:#fff; top:-20px; border:1px solid #ccc;
...
#prj_right .btn_menu ul li span a, #prj_right .btn_menu ul li ul li a {color:#555 !important;}
</style>
 		<!-- 좌측 추가 영역 -->
        <div id="prj_right">
        	<div class="btn_menu">
