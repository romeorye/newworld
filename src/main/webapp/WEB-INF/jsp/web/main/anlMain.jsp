...
.ts_main #prj_right h4 { color: #c40452; font-weight: 600; text-align:center; font-size: 16px; padding-top:5px; border-bottom:1px solid #ddd;  margin-bottom:0; line-height:2.5;}
...
.ts_main #prj_right .QuickMenu_con02 h5 {margin-top:0;}
.ts_main #prj_right .QuickMenu_con02 ul li:nth-of-type(1) .icon_quick {background:url(/iris/resource/web/images/newIris/img_anlmain.png) no-repeat center 14px ;}
.ts_main #prj_right .QuickMenu_con02 ul li:nth-of-type(2) .icon_quick {background:url(/iris/resource/web/images/newIris/img_anlmain.png) no-repeat center -118px ;}
.ts_main #prj_right .QuickMenu_con02 ul li:nth-of-type(3) .icon_quick {background: url(/iris/resource/web/images/newIris/img_anlmain.png) no-repeat center -235px ;}
.ts_main #prj_right .QuickMenu_con02 ul li:nth-of-type(1):hover .icon_quick {background:url(/iris/resource/web/images/newIris/img_anlmain.png) no-repeat center -359px ;}
.ts_main #prj_right .QuickMenu_con02 ul li:nth-of-type(2):hover .icon_quick {background:url(/iris/resource/web/images/newIris/img_anlmain.png) no-repeat center -491px ;}
.ts_main #prj_right .QuickMenu_con02 ul li:nth-of-type(3):hover .icon_quick {background: url(/iris/resource/web/images/newIris/img_anlmain.png) no-repeat center -608px ;}</style>
		    <!--content-->
