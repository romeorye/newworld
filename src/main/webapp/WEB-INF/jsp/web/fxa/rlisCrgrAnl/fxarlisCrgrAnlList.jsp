...
<script type="text/javascript">
	...
	Rui.onReady(function() {
        ...
        var columnModel = new Rui.ui.grid.LColumnModel({
            columns: [
        	 	      { field: 'prjNm'    	, label: '프로젝트명',  	sortable: false,	align:'left', width: 370}
                    , { field: 'crgrNm'     , label: '담당자',  		sortable: false,	align:'center', width: 170, editor: popupUserInfo, renderer: Rui.util.LRenderer.popupRenderer() }
                    , { field: 'rfpNm'      , label: '통보자',  		sortable: false,	align:'center', width: 350, editor: popupMultiUserInfo, renderer: Rui.util.LRenderer.popupRenderer() }
                    , { field: 'regDt'      , label: '등록일',  		sortable: false,	align:'center', width: 140}
