	...
	Rui.onReady(function(){
	    ...
	    var columnModel = new Rui.ui.grid.LColumnModel({
	        ...
	        columns: [
	        	...
	        	{ field: 'prctTitl', label: '신청제목', 	sortable: false, align: 'left', width: 280},
	        	{ field: 'mchnHanNm', label: '장비명', 	sortable: false, align: 'left', width: 280},
	        	{ field: 'rgstTeamNm', label: '팀명', 	sortable: false, align: 'left', width: 190},
