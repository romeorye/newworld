	...
	Rui.onReady(function(){
	    ...
	    var columnModel = new Rui.ui.grid.LColumnModel({
	        ...
	        columns: [
	            ...
	            { field: 'opnYn', 			label: 'open', 		sortable: false, align: 'center', width: 85},
	            { field: 'mchnUsePsblYn',  	label:'기기사용여부' , 		sortable: false, align: 'center', width: 85},
	            { field: 'mchnUsePsblNm', 		label: '장비사용상태', 		sortable: false, align: 'center', width: 85},
