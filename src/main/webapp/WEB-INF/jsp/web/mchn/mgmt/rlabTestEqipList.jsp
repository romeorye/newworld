...
<script type="text/javascript">
	...
	Rui.onReady(function(){
	    ...
	    var columnModel = new Rui.ui.grid.LColumnModel({
	        groupMerge: true,
	        columns: [
	            { field: 'mchnHanNm',  		label:'장비명', 		sortable: false, align: 'center', width: 210},
	            ...
	            { field: 'smpoQty', 		label: '시료수', 		sortable: false, align: 'center', width: 60},
	            { field: 'mchnLaclNm', 		label: '대분류', 		sortable: false, align: 'center', width: 130},
	            { field: 'mchnClDtlNm', 	label: '소분류', 		sortable: false, align: 'center', width: 130},
	            { field: 'mchnClNm', 		label: '장비종류', 		sortable: false, align: 'center', width: 130},
	            { field: 'opnYn', 			label: 'open', 		sortable: false, align: 'center', width: 87},
	            { field: 'mchnUsePsblNm', 		label: '장비사용상태', 		sortable: false, align: 'center', width: 87},
	            { field: 'mchnUsePsblYn',  	hidden : true},
...
nG.saveExcel(encodeURIComponent('신뢰성시험 장비_') + new Date().format('%Y%m%d') + '.xls', {
