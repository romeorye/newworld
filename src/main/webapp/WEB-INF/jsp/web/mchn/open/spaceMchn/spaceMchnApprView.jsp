 ...
 *************************************************************************
 * $Id		: mchnApprView.jsp
 * @desc    : Instrument >  공간성능평가 Tool > 보유 TOOL view (통합검색용)
 *------------------------------------------------------------------------
		...
		<div class="sub-content">
			<form name="aform" id="aform" method="post">
				<table class="table table_txt_right">
					...
					<tbody>
						<tr>
							<th align="right">TOOL명(국문)</th>
							<td>
								<c:out value='${result.mchnHanNm}'/>
							</td>
							<th align="right">TOOL명(영문)</th>
							<td>
