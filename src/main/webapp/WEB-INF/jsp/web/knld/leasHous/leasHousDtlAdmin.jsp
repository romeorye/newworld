	...
	Rui.onReady(function() {
       ...
       //협의서
        ...
        fncLeasHousList = function(){
      	...
      	//검토 의견
        rvwCmmt = new Rui.ui.form.LTextArea({
            applyTo: 'rvwCmmt',
            height: 100,
            width: 1022
        });
        ...
        fnRvwAppr = function(gbn){
        	...
        	dataSet.setNameValue(0, 'rvwCmmt', rvwCmmt.getValue());

	        dataSet.setNameValue(0, 'pgsStCd', "PRI");
        	...
        	dm.updateDataSet({
                dataSets:[dataSet],
                url:'<c:url value="/knld/leasHous/updateLeasHousPriSt.do"/>',
                params: {
