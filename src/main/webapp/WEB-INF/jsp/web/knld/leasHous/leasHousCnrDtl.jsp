...
/*
 *************************************************************************
 * $Id		: leasHousCnrDtl.jsp
 * @desc    : 임차주택 계약검토신청화면(관리자용)
 *------------------------------------------------------------------------
...
var lshCnttSpctDialog
	...
	Rui.onReady(function() {
        ...
        /* [전세계약서 특약확인] */
		lshCnttSpctDialog = new Rui.ui.LFrameDialog({
	        id: 'lshCnttSpctDialog',
	        title: '전세계약서 특약확인',
	        width:  500,
	        height: 500,
	        modal: true,
		...
		lshCnttSpctDialog.render(document.body);
        ...
        dataSet.on('load', function(e) {
        	if(  dataSet.getNameValue(0, 'pgsStCd') == "PRI"){
				$("#btnReq").show();
			}else{
				$("#btnReq").hide();
			}
      ...
      //협의서
        ...
        getAttachFileId = function(gbn) {
            ...
            if ( gbn =="RG" ){
            	...
            	lvAttcFilId = dataSet.getNameValue(0, 'lshCntdAttcFilId');
            }
        ...
        fnRvwReq = function(){
        	...
        	dm.updateDataSet({
                dataSets:[dataSet],
                url:'<c:url value="/knld/leasHous/updateLeasHousCnrReq.do"/>',
                params: {
        ...
        fncLshCnttSpctPop = function(){
        	lshCnttSpctDialog.setUrl('<c:url value="/knld/leasHous/retrieveLshCnttSpctPop.do"/>');
        	lshCnttSpctDialog.show(true);
        }
...
<div class="contents">
	...
	<div class="sub-content">
   				...
   				<table class="table table_txt_right">
   					...
   					<tbody>
   						<tr>
   							<th align="right">임차주택관리합의서 여부</th>
							<td>
		        ...
		        <h4>- 전세계약서 검토요청</h4>
   				<table class="table table_txt_right">
   					...
   					<tbody>  		
   						<tr>
		         			<th>전세계약서 </th>
		         			<td id="lshCntdAttchFileView">&nbsp;</td>
		         			<td><button type="button" class="btn" id="lshCntdAttchFileMngBtn" name="attchFileMngBtn" onclick="openAttachFileDialog(setAttachFileInfo4, getAttachFileId('LS'), 'knldPolicy', '*')">첨부파일등록</button></td>
		         			<td>
		         				 <button type="button" class="btn" id="btnReq" onclick="fncLshCnttSpctPop()">전세계약 특약사항</button>
		         			</td>
		         		</tr>
   					</tbody>
   				</table>
