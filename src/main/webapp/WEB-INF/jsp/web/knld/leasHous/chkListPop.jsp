...
<div class="LblockMainBody">
	<div class="sub-content">
   			<div style="text-align:left;font-weight:bold;font-size:1.3em;font-family:LG스마트체2.0;" >- 계약 전 체크사항</div> 
   			<br/>
   			...
   			<div style="text-align:left;font-weight:bold;font-size:1.3em;font-family:LG스마트체2.0;" >- 계약 시</div>
   			<br/>
   			 1. 특약사항 기본문구 외 당사가 요구하는 사항을 필수적으로 작성한다</br>
   			 </br>
   			 2. 특약 필수기제사항으로는 00억 전세보증금인 경우 잔금일자,㈜엘지하우시스에서,0억을 임대인 명의계좌로 송금하며</br>
   			   &nbsp;&nbsp;&nbsp;(임대인계좌 00은행/123-3456-000 홍길동)나머지 00천 만원은  세입자 000씨가 임대인 명의계좌로 송금한다 </br>
   			   </br>   
                    &nbsp;&nbsp;&nbsp;예시) 본 계약 만기 시에는 임대인 명의로 ㈜엘지하우시스 법인계좌(우리은행 123-456-000)로  00억을 송금하며 나머지</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 잔금 0천만원에 대하여 임대인은 세입자 홍길동 계좌명의로 송금한다</br>
             ...
             4. 법무팀 계약서 검토 시 임대인,중개사의 인장날인 또는 자필서명 된 것으로 제출한다.</br>
   			 ...
   			 <div style="text-align:left;font-weight:bold;font-size:1.3em;font-family:LG스마트체2.0;" >- 연장,만기 시 체크사항</div>
   			<br/>
