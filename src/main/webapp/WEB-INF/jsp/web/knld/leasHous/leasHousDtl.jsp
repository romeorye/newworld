...
//var leasHousDplDialog;
	...
	Rui.onReady(function() {
        ...
        /* [ 임차주택 Dialog] 
		leasHousDplDialog = new Rui.ui.LFrameDialog({
	        id: 'leasHousDplDialog',
	        title: '임차주택 확약서',
	        width:  500,
	        height: 500,
	        modal: true,
		...
		leasHousDplDialog.render(document.body);
		*/
        ...
        dataSet.on('load', function(e) {
			...
			if( !Rui.isEmpty( dataSet.getNameValue(0, 'dplAttcFilId') )  ){
				getAttachFileList5(dataSet.getNameValue(0, 'dplAttcFilId'));
			}
       ...
       /*  
        fncLeasHousDpyPop = function(){
        	if (dplYn.getValue() == "Y"){
        		alert("확약서에 동의하셨습니다.");
        		return;
        	}
        	
        	leasHousDplDialog.setUrl('<c:url value="/knld/leasHous/retrieveLeasHousDpyPop.do"/>');
        	leasHousDplDialog.show(true);
        }
         */
        fnSave = function(){
        	//서버전송용
      ...
      //목록화면으로 이동
        ...
        vm = new Rui.validate.LValidatorManager({
            validators: [
            		...
            		//,{ id : 'pslfAmt'		, validExp : '본인부담금 :true'}   
