...
//             	patentInfoDataSet.setNameValue(0, 'sbcNm', sbcNm);
              ...
              //등록자와 사용자가 다를때 수정/삭제버튼 가리기
                pRgstId = patentInfoDataSet.getNameValue(0, "rgstId");
            ...
            patentRgstSave = function() {
         	   var record = patentInfoDataSet.getAt(patentInfoDataSet.getRow());
	...
	<%--/*******************************************************************************
   	 * FUNCTION 명 : fncDeletePatentInfo (특허 삭제)
   	 * FUNCTION 기능설명 : 특허 삭제
   	 *******************************************************************************/--%>
	    fncDeletePatentInfo = function(){

	    	var dm1 = new Rui.data.LDataSetManager({defaultFailureHandler: false});

    		dm1.updateDataSet({
    	        url: "<c:url value='/knld/pub/deletePatentInfo.do'/>",
    	        dataSets:[patentInfoDataSet],
    	        params: {
    	        	patentId : patentId
    	        }
	    	});
	    	...
	    	dm1.on('success', function(e) {
				var resultData = patentInfoDataSet.getReadData(e);
