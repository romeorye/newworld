...
//	var ptoprptDataSet;
	...
	Rui.onReady(function() {
       	...
       	var mboColumnModel = new Rui.ui.grid.LColumnModel({
       	    columns: [
         	    ...
         	    , { field: 'mboGoalPrvs',    label: '목표항목', sortable: false, align:'left', width: 330
       	        ...
       	        , { field: 'mboGoalAltp',    label: '배점'    , sortable: false, align:'right', width: 40 }
       	        , { field: 'mboGoalL',       label: '목표수준', sortable: false, align:'left', width: 310
       	        	, renderer: function(value, p, record){
 	                    p.tooltipText = value;
 		        		return value;
 		        	  }  
       	        ...
       	        , { field: 'arlsStts',       label: '진척현황', sortable: false, align:'left', width: 310
       	        	, renderer: function(value, p, record){
 	                    p.tooltipText = value;
 		        		return value;
 		        	  }  
         	      }
       	        , { field: 'filId',  label: '첨부파일', align:'center', width: 70 ,
        ...
        var columnModel = new Rui.ui.grid.LColumnModel({
            columns: [
                  { field: 'tssNm',        label: '과제명', sortable: true, align:'left', width: 350 }
                , { field: 'saUserName',   label: '과제리더', sortable: true, align:'center', width: 150 }
                , { field: 'deptName',     label: '조직', sortable: true, align:'center', width: 230 }
                , { id: 'G1', label: '과제기간(계획일)' }
                , { field: 'tssStrtDd',    label: '시작일', groupId: 'G1', sortable: true, align:'center', width: 130 } 
                , { field: 'tssFnhDd',     label: '종료일', groupId: 'G1', sortable: true, align:'center', width: 130 }
                , { field: 'progressrate', label: '진척율<br>(실적/계획)', sortable: true, align:'center', width: 100 }
                , { id: 'pg', label: '진척도', align:'center', width: 80 ,renderer :function(value, p, record, row, col) {
