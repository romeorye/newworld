...
<script type="text/javascript">
    ...
    Rui.onReady(function() {
        ...
        var pointVali = new Rui.validate.LValidatorManager({
            validators: [
                { id: 'evScr', validExp: '평가점수:true' , fn: function(value, row){
                	if (row.grsEvSn == 46 || row.grsEvSn == 47){
                		if ( row.evScr == 2 || row.evScr == 4){
                			this.message = "평가점수에 2, 4점은 넣을수 없습니다."
                			return fals;
                		} 
                	}
                }} //minLength=1&maxLength=10 :number&minNumber=1&maxNumber=5
            ]
        });
