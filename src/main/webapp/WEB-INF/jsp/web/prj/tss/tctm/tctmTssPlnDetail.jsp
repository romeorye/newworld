...
<script type="text/javascript">
	var lisrUrl = "/prj/tss/tctm/tctmTssList.do";
	var listQrylUrl = "";
	var detailUrl = "/prj/tss/tctm/tctmTssPlnDetail.do";
	var detailQrylUrl = "";
	var detailSummaryUrl = "/prj/tss/tctm/tctmTssPlnSmryIfm.do";
    ...
    Rui.onReady(function() {
      ...
      //연구분야
        ...
        dataSet.on('load', function(e) {
            ...
            tabView.selectTab(0);
            nwinsActSubmit(document.tabForm, "<c:url value='/prj/tss/tctm/tctmTssPlnSmryIfm.do?tssCd=" + gvTssCd + "'/>", 'tabContent0');
        });
...
//             }
            ...
            case 0:
                if(e.isFirst) {
                    tabUrl = "<c:url value='/prj/tss/tctm/tctmTssPlnSmryIfm.do?tssCd=" + gvTssCd + "'/>";
            ...
            case 1:
                if(e.isFirst) {
                    tabUrl = "<c:url value='/prj/tss/tctm/tctmTssPlnGoalYldIfm.do?tssCd=" + gvTssCd + "'/>";
        ...
        btnDelRq.on('click', function() {
        	if(confirm("삭제를 하시겠습니까?")) {
        		...
        		dm.on('success', function(e) {
    	  	    	nwinsActSubmit(document.mstForm, "<c:url value='/prj/tss/tctm/tctmTssList.do'/>");
    			});
        });
        ...
        fnSave = function() {
            ...
            if(confirm("저장하시겠습니까?")) {
                ...
                dataSet.setNameValue(0, "tssScnCd", "G");   //과제구분: G(기술팀)
                        ...
                        <table class="table table_txt_right">
							...
							<tbody>
								...
								<tr>
									...
									<td><span id='seed'></span>
									<input type="text" id="wbsCd" /></td>
