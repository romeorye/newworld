...
<script type="text/javascript">
    ...
    Rui.onReady(function() {
        ...
        fnCsusContentsCreate = function(gbn) {
            ...
            csusCont += '</div>';
            csusCont += '<div class="titArea"><h3>1. 프로젝트 기본사항</h3></div>';
            ...
            csusCont += '                <tbody>';
            csusCont += '                    <tr>';
            csusCont += '                        <th>프로젝트코드</th>';
            csusCont += '                        <td>${resultMst.wbsCd}</td>';
            csusCont += '                        <th>연구부서명</th>';
            csusCont += '                        <td>${resultMst.deptName}</td>';
            csusCont += '                    </tr>';
            csusCont += '                    <tr>';
            csusCont += '                        <th>연구개발기간</th>';
            csusCont += '                        <td>${resultSmry.ttlCrroStrtDt} ~ ${resultSmry.ttlCrroFnhDt}</td>';
            csusCont += '                        <th>소요기간</th>';
            csusCont += '                        <td>${resultInfo.mMDiff} 개월</td>';
            csusCont += '                    </tr>';
            csusCont += '                    <tr>';
            csusCont += '                        <th>참여연구원</th>';
            csusCont += '                        <td colspan="3">${resultInfo.mbrNmList}</td>';
            csusCont += '                    </tr>';
            csusCont += '                </tbody>';
            csusCont += '            </table>';
            ...
            csusCont += '                    <tr>';
            csusCont += '                        <th>과제개요</th>';
            csusCont += '                        <td>'+tssSmryTxt+'</td>';
            csusCont += '                    </tr>';
            csusCont += '                </tbody>';
            csusCont += '            </table>';
            csusCont += '<div class="titArea"><h3>3. 개밸계획 대비 실적 개요</h3></div>';
            csusCont += '            <table class="table table_txt_right">';
            csusCont += '                <colgroup>';
            csusCont += '                    <col style="width:30%"/>';
            csusCont += '                    <col style="width:35%"/>';
            csusCont += '                    <col style="width:35%"/>';
            csusCont += '                </colgroup>';
            csusCont += '                <tbody>';
            csusCont += '                    <tr>';
            csusCont += '                        <th>항목</th>';
            csusCont += '                        <th>계획(개발계획시점)</th>';
            csusCont += '                        <th>실적(개발중단시점)</th>';
            csusCont += '                    </tr>';
            csusCont += '                    <tr>';
            csusCont += '                        <th>개발기간</th>';
            csusCont += '                        <td class="alignC">${resultMst.dcacBStrtDd} ~ ${resultMst.dcacBFnhDd}</td>';
            csusCont += '                        <td class="alignC">${resultMst.dcacNxStrtDd} ~ ${resultMst.dcacNxFnhDd}</td>';
            csusCont += '                    </tr>';
            csusCont += '                    <tr>';
            csusCont += '                        <th>총 개발비 투자</th>';
            csusCont += '                        <td class="alignR">${resultInfo.bizAtmSum}</td>';
            csusCont += '                        <td class="alignR">${resultSmry.bizExp}</td>';
            csusCont += '                    </tr>';
            csusCont += '                </tbody>';
            csusCont += '            </table>';
            csusCont += '<div class="titArea"><h3>4. 연구개발 성과</h3></div>';
            csusCont += '            <table class="table table_txt_right">';
            csusCont += '                <colgroup>';
            csusCont += '                    <col style="width:20%"/>';
            csusCont += '                    <col style="width:*"/>';
            ...
            csusCont += '                        <td>'+rsstDvlpOucmTxt+'</td>';
            csusCont += '                    </tr>';
            csusCont += '                </tbody>';
            csusCont += '            </table>';
            csusCont += '<div class="titArea"><h3>5. 향후 계획</h3></div>';
            csusCont += '            <table class="table table_txt_right">';
            csusCont += '                <colgroup>';
            csusCont += '                    <col style="width:20%"/>';
            csusCont += '                    <col style="width:*"/>';
            ...
            csusCont += '<div class="titArea"><h3>6. 비고</h3></div>';
            csusCont += '            <table class="table table_txt_right">';
            csusCont += '                <colgroup>';
            csusCont += '                    <col style="width:20%"/>';
            csusCont += '                    <col style="width:*"/>';
            ...
            csusCont += '                    <tr>';
            csusCont += '                        <th>비고</th>';
            csusCont += '                        <td>'+remTxt+'</td>';
            csusCont += '                    </tr>';
            csusCont += '                </tbody>';
            csusCont += '            </table>';
            csusCont += '<div class="titArea"><h3>7. 첨부파일</h3></div>';
            } 
            else {
