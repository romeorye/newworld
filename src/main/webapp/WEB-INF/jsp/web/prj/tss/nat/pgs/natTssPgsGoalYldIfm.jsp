    ...
    Rui.onReady(function() {
        ...
        var columnModel1 = new Rui.ui.grid.LColumnModel({
            ...
            columns: [
                ...
                , { field: 'prvs',  label: '항목', sortable: false, align:'left', width: 200 }
                , { field: 'evWay', label: '평가방법', sortable: false, align:'left', width: 180 }
                , { field: 'utm',   label: '단위', sortable: false, align:'left', width: 80 }
                , { field: 'cur',   label: '현재', sortable: false, align:'left', width: 150 }
                , { field: 'goal',  label: '목표', sortable: false, align:'left', width: 150 }
                , { field: 'achvL', label: '달성수준', sortable: false, align:'left', width: 150 }
                , { field: 'arsl',  label: '실적', sortable: false, align:'left', width: 150, editor: new Rui.ui.form.LTextArea() }
            ]
        });
