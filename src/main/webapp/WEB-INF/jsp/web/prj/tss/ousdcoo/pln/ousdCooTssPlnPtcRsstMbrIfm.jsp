...
/*
 *************************************************************************
 * $Id      : ousdCooTssPlnPtcRsstMbrIfm.jsp
...
<script type="text/javascript">
    ...
    Rui.onReady(function() {
        ...
        disableFields = function() {
            ...
            // 연구원 렌더러 제거
            columnModel.getColumnByField('saUserName').renderer = '';
            
            // 체크박스, 상태 컬럼 제거
            columnModel.getColumnAt(0).setHidden(true);
            columnModel.getColumnAt(1).setHidden(true);
        	...
        	Rui.confirm({
                ...
                handlerYes: function() {
                    ...
                    if(dbCallYN) {
	                    ...
	                    dm.updateDataSet({
	                        url:'<c:url value="/prj/tss/ousdcoo/deleteOusdCooTssPlnPtcRsstMbr.do"/>',
	                        dataSets:[dataSet]
	                    });
                    }
                },
        ...
        btnSave.on('click', function() {
            ...
            dm.updateDataSet({
                url:'<c:url value="/prj/tss/ousdcoo/updateOusdCooTssPlnPtcRsstMbr.do"/>',
                dataSets:[dataSet]
            });
        });
       /*  
