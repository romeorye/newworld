            ...
            *******************/
            ...
            var userColumnModel = new Rui.ui.grid.LColumnModel({
                ...
                <c:if test="${inputData.cnt != 1}">
                    ...
                    , { field : 'deptName',		label : '부서',		sortable : false,	align :'center',	width : 100 }
                    , { field : 'tssNm',		label : '과제명',		sortable : false,	align :'center',	width : 100 }
                    , { field : 'ptcStrtDt',	label : '과제시작일',	sortable : false,	align :'center',	width : 100 }
                    , { field : 'ptcFnhDt',		label : '종료일',		sortable : false,	align :'center',	width : 100 }
                    , { field : 'ptcPro',		label : '참여율',		sortable : false,	align :'center',	width : 100 }
                ]
            });
            ...
            getUserList = function() {
            	userDataSet.load({
                    url : '<c:url value="/com/tss/getTssUserList.do"/>',
                    params : {
