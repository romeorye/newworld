        ...
        <div class="sub-content">
            <form name="aform" id="aform" method="post">
                <div id="csusContents">
                    ...
                    <div class="titArea"><h3>3. 향후 계획 및 중단 사유</h3></div>
                    <table class="table table_txt_right">
                        <colgroup>
                        ...
                        <tr>
                            ...
                            <td  style="height:150px;min-height: 150px;vertical-align: top"><c:out value="${fn:replace(resultSmry.fnoPlnTxt, cn, br)}" escapeXml="false"/></td>
                        </tr>
                        <tr>
                            <th align="right">중단 사유</th>
                            <td  style="height:150px;min-height: 150px;vertical-align: top"><c:out value="${fn:replace(resultSmry.dcacRsonTxt, cn, br)}" escapeXml="false"/></td>
                        </tr>
                        </tbody>
                    </table>
