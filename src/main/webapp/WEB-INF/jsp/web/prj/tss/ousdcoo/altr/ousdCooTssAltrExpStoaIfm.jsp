            ...
            Rui.confirm({
                ...
                handlerYes: function() {
                    ...
                    if( stringNullChk(dataSet.getAt(0).get("tssCd")) == "") {
                        ...
                        dm.updateDataSet({
                            modifiedOnly: false,
                            url:'<c:url value="/prj/tss/ousdcoo/insertOusdCooTssAltrExpStoa.do"/>',
                            dataSets:[dataSet]
                        });
                    }
                    //수정
                        ...
                        dm.updateDataSet({
                            modifiedOnly: false,
                            url:'<c:url value="/prj/tss/ousdcoo/updateOusdCooTssAltrExpStoa.do"/>',
                            dataSets:[dataSet]
                        });
                    }
                },
    ...
    <form name="expStoaForm" id="expStoaForm" method="post">
        ...
        <table class="table table_txt_right">
            ...
            <tbody>
            	...
            	<tr>
            		<td align="center" style="text-align: center;" >금액(원)</th>
