...
/*
 *************************************************************************
 * $Id      : ousdCooTssPgsPtcRsstMbrIfm.jsp
 * @desc    : 대외협력과제 - 진행 > 참여연구원 탭 화면
 *------------------------------------------------------------------------
...
/*         var columnModel = new Rui.ui.grid.LColumnModel({
        ...
        var columnModel = new Rui.ui.grid.LColumnModel({
            ...
            columns: [
                ...
                , { field: 'deptName', label: '소속', sortable: false, align:'left', width: 250 }
                , { field: 'ptcStrtDt', label: '참여기간', sortable: false, align:'center', width: 120 }
                , { field: 'ptcFnhDt', label: '참여기간', sortable: false, align:'center', width: 120 }
                ...
                handlerYes: function() {
                    ...
                    for(var i = 0; i < dataSet.getCount(); i++) {
                    	if(dataSet.getState(i) == 3) {
                    		...
                    		dataSet.setState(i, Rui.data.LRecord.STATE_NORMAL);
                    	}
                    }
