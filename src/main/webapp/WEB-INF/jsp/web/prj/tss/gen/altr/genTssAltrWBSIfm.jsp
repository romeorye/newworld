...
//         }
        ...
        fnSearch = function() {
            dataSet.load({
                url: "<c:url value='/prj/tss/gen/retrieveGenTssAltrWBS.do'/>"
              , params : {
                    tssCd : lvTssCd
                }
            });
        ...
        btnSave.on('click', function() {
            ...
            Rui.confirm({
                ...
                handlerYes: function() {
                    ...
                    dm.updateDataSet({
                        url:'<c:url value="/prj/tss/gen/updateGenTssAltrWBS.do"/>',
                        dataSets:[dataSet]
                    });
                },
        ...
        if($("#butChart").length > 0){ //[20240411.siseo]id 존재여부 체크 추가
            ...
            butChart.on('click', function() {
                 ...
                 var url =  contextPath + "/prj/tss/gen/genWbsGanttChartPopup.do?"
                     ...
                     if(dataSet.getCount() > 0) {
                     nwinsOpenModal(url, args, 1200, 500);
                     }else{
                          Rui.alert('조회된 데이타가 없습니다.');
                     }
