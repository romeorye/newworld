                            ...
                            <tbody>
                                <tr>
                                    <th align="right">신제품명</th>
                                    	<td>
					                    	 <c:out value='${resultData.nprodNm}'/>
					                    </td>
                                </tr>
                                <tr>
                                    <th align="right">예상출시일(계획)</th>
                                    <td>
					                    	 <c:out value='${resultData.ancpOtPlnDt}'/>
					                    </td>
                                </tr>
                                <tr>
                                    <th align="right">Qgate3(품질평가단계) 패스일자</th>
                                      <td>
					                    	 <c:out value='${resultData.qgate3Dt}' />
					                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                	<td  colspan="2">
                		<c:choose>
							...
							<c:otherwise>
								<c:out value="${fn:replace(resultData.fwdPlnTxt, cn, br)}" escapeXml="false"/>
							</c:otherwise>
                        </c:choose>
                    </td>
                </tr>
