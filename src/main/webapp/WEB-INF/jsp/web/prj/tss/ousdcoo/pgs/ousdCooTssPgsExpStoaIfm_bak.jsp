...
<script type="text/javascript">
    ...
    Rui.onReady(function() {
        ...
        dataSet.on('load', function(e) {
        	var addNosCash  = numberNullChk(dataSet.getNameValue(0, 'yyNosCash1'))+numberNullChk(dataSet.getNameValue(0, 'yyNosCash2'))+numberNullChk(dataSet.getNameValue(0, 'yyNosCash3'))+numberNullChk(dataSet.getNameValue(0, 'yyNosCash4'));
        	var totCash = numberNullChk(dataSet.getNameValue(0, 'ttlCash'));
        	dataSet.setNameValue(0,'remainCash'  , totCash-addNosCash);
        });
...
//        	        console.log('originValue:'+e.originValue); //원본값
//        	        console.log('beforeValue:'+e.beforeValue); //이전값
        ...
        <table class="table table_txt_center">
            ...
            <tbody>
            	...
            	<tr>
            		...
            		<td align="center" colspan="4" style="text-align: center;" ><span id="ttlCash"></span></td>
            		<!-- <td><div id=""/></td>
            		<td><div id=""/></td>
            		<td><div id=""/></td> -->
            		<td><div id=""/></td>
