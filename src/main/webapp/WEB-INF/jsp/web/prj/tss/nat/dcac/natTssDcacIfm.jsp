...
//     }
    ...
    Rui.onReady(function() {
        ...
        //실적사업비총액
        bizExp = new Rui.ui.form.LNumberBox({
            applyTo: 'bizExp',
            width: 200
        });
        ...
        dataSet = new Rui.data.LJsonDataSet({
            ...
            fields: [
                ...
                , { id: 'bizExp', type: 'number', defaultValue:0 }          //실적사업비총액
                , { id: 'dcacRsonTxt' }     //중단사유
                , { id: 'attcFilId' }       //첨부파일
        ...
        var bind = new Rui.data.LBind({
            ...
            bindInfo: [
                ...
                , { id: 'bizExp',          ctrlId: 'bizExp',          value: 'value' }
        ...
        vm = new Rui.validate.LValidatorManager({
            validators: [  
                ...
                , { id: 'bizExp',            validExp: '실적사업비총액:false' }
    ...
    <form name="aForm" id="aForm" method="post" style="padding: 20px 1px 0px 0;">
        ...
        <table class="table table_txt_right">
            ...
            <tbody>
                ...
                <tr>
                    <th>실적사업비총액</th>
                    <td colspan="2"><input type="text" id="bizExp" /></td>
                </tr>
                <tr>
                    <th>과제완료보고서 및 기타</th>
