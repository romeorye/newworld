...
/*
 *************************************************************************
 * $Id      : ousdCooTssPgsExpStoaIfm.jsp
 * @desc    : 대외협력과제 > 진행 비용지급실적 탭 화면
 *------------------------------------------------------------------------
...
<script type="text/javascript">
    ...
    var pageMode = lvTssSt == "100" && lvPageMode == "W" && lvPgsCd == "PG" ? "W" : "R";
...
//                , { id: 'rsstExp',             ctrlId: 'rsstExp',              value: 'html' }      /*연구비(원)*/
...
//                 , { id: 'saSabunNew',   validExp: '담당연구원:true' }
        ...
        //저장
        fnSave = function() {
/*             if(!vm.validateGroup("expStoaForm")) {
            ...
            Rui.confirm({
                ...
                handlerYes: function() {
                    ...
                    if( stringNullChk(dataSet.getAt(0).get("tssCd")) == "") {
                        ...
                        dm.updateDataSet({
                            modifiedOnly: false,
                            url:'<c:url value="/prj/tss/ousdcoo/insertOusdCooTssPgsExpStoa.do"/>',
                            dataSets:[dataSet]
                        });
                    }
                    //수정
                        ...
                        dm.updateDataSet({
                            modifiedOnly: false,
                            url:'<c:url value="/prj/tss/ousdcoo/updateOusdCooTssPgsExpStoa.do"/>',
                            dataSets:[dataSet]
                        });
                    }
                },
    ...
    <form name="expStoaForm" id="expStoaForm" method="post">
        ...
        <table class="table table_txt_right">
            ...
            <tbody>
            	...
            	<tr>
            		<td align="center" rowspan="2" style="text-align: center;" ><span id="rsstExpConvertMil"></span> 억</td>
            		<td align="center" style="text-align: center;" >일시</td>
            		<td align="center"><input type="text" id="inputYyNosDt1"/><span id="spnYyNosDt1" class="readSpn" style="display: none;"></span></td>
            		<td align="center"><input type="text" id="inputYyNosDt2"/><span id="spnYyNosDt2" class="readSpn" style="display: none;"></span></td>
            		<td align="center"><input type="text" id="inputYyNosDt3"/><span id="spnYyNosDt3" class="readSpn" style="display: none;"></span></td>
            		<td align="center"><input type="text" id="inputYyNosDt4"/><span id="spnYyNosDt4" class="readSpn" style="display: none;"></span></td>
            		<td></th>
            	</tr>
            	<tr>
            		<td align="center" style="text-align: center;" >금액</th>
            		<td align="center"><input type="text" id="inputYyNosCash1"/><span id="spnYyNosCash1" class="readSpn" style="display: none;"></span></td>
            		<td align="center"><input type="text" id="inputYyNosCash2"/><span id="spnYyNosCash2" class="readSpn" style="display: none;"></span></td>
            		<td align="center"><input type="text" id="inputYyNosCash3"/><span id="spnYyNosCash3" class="readSpn" style="display: none;"></span></td>
            		<td align="center"><input type="text" id="inputYyNosCash4"/><span id="spnYyNosCash4" class="readSpn" style="display: none;"></span></td>
            		<td align="center"><span id="remainCash"></span></td>
            	</tr>
            	<tr>
            		<td align="center" style="text-align: center;" >합계</td>
            		<td align="center" style="text-align: center;" >금액</td>
            		<td align="center"><span id="ttlCash"></span></td>
            		<td><div id=""/></td>
            		<td><div id=""/></td>
            		<td><div id=""/></td>
            		<td></th>
