...
/*
 *************************************************************************
 * $Id      : ousdCooTssPlnGoalYldIfm.jsp
 * @desc    : 대외협력과제 > 목표 및 산출물 탭 화면
 *------------------------------------------------------------------------
    ...
    Rui.onReady(function() {
        ...
        var columnModel1 = new Rui.ui.grid.LColumnModel({
            ...
            columns: [
                ...
                , { field: 'step',  label: '단계',     sortable: false, align:'left', width: 100, editor: gridTextBox }
                , { field: 'prvs',  label: '평가항목', sortable: false, align:'left', width: 180, editor: gridTextArea }
                , { field: 'evWay', label: '평가방법', sortable: false, align:'left', width: 180, editor: gridTextArea }
                , { field: 'goal',  label: '목표수준', sortable: false, align:'left', width: 180, editor: gridTextArea }
                , { field: 'cur',   label: '현재수준', sortable: false, align:'left', width: 180, editor: gridTextArea }
...
//                 , { id: 'saSabunNew',   validExp: '담당연구원:true' }
            ...
            Rui.confirm({
                ...
                handlerYes: function() {
                    ...
                    if(dbCallYN) {
                        ...
                        dm.updateDataSet({
                            url:'<c:url value="/prj/tss/ousdcoo/deleteOusdCooTssPlnGoal.do"/>',
                            dataSets:[dataSet1]
                        });
                    }
                },
        ...
        btnGoalSave.on('click', function() {
            ...
            Rui.confirm({
                ...
                handlerYes: function() {
                    dm.updateDataSet({
                        url:'<c:url value="/prj/tss/ousdcoo/updateOusdCooTssPlnGoal.do"/>',
                        dataSets:[dataSet1]
                    });
                },
                handlerNo: Rui.emptyFn
            ...
            Rui.confirm({
                ...
                handlerYes: function() {
                    ...
                    if(dbCallYN) {
                        ...
                        dm.updateDataSet({
                            url:'<c:url value="/prj/tss/ousdcoo/deleteOusdCooTssPlnYld.do"/>',
                            dataSets:[dataSet2]
                        });
                    }
                },
        ...
        btnYldSave.on('click', function() {
            ...
            dm.updateDataSet({
                url:'<c:url value="/prj/tss/ousdcoo/updateOusdCooTssPlnYld.do"/>',
                dataSets:[dataSet2]
            });
        });
      /*   
        ...
        fnSearch = function(targetDs) {
        	if(targetDs == "GOAL") {
	            dataSet1.load({ 
	                url: "<c:url value='/prj/tss/ousdcoo/retrieveOusdCooTssPlnGoal.do'/>"
	              , params : {
	                    tssCd : lvTssCd
	                }
	            });
	            ...
	            dataSet2.load({ 
	                url: "<c:url value='/prj/tss/ousdcoo/retrieveOusdCooTssPlnYld.do'/>"
	              , params : {
	                    tssCd : lvTssCd
	                }
	            });
