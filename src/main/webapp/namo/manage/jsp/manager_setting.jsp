...
<title>Namo CrossEditor : Admin</title>
	<script type="text/javascript">var pe_wr="pe_Ll"; </script>
...
<form method="post" id="adminSetForm" name="adminSetForm" action="manager_proc.jsp" onsubmit="return pe_bL();">
			...
			<td class="pe_if">
				...
				<table id="Info">
					<tr>
						...
						<font style="font-size:14pt;color:#3e77c1;font-weight:bold;text-decoration:none;"><span id="pe_Cx"></span></font></td>
						<td id="InfoText"><span id="pe_xb"></span></td>
					</tr>
					<tr>
				...
				<table class="pe_mH">
					<tr>
						<td class="pe_aAn">				
							<ul>
								<li class="pe_kC pe_LV"><input type="button" id="setting_base" value="" style="width:110px;height:28px;" class="pe_uL pe_gQ" /></li>
								<li class="pe_kC"><input type="button" id="setting_edit" value="" style="width:110px;height:28px;" class="pe_uL pe_gQ" /></li>
								<li class="pe_kC"><input type="button" id="setting_view" value="" style="width:110px;height:28px;" class="pe_uL pe_gQ" /></li>
								<li class="pe_kC"><input type="button" id="setting_ab" value="" style="width:110px;height:28px;" class="pe_uL pe_gQ" /></li>
							</ul>
						
						</td>
					</tr>
					<tr>
						<td class="pe_mb pe_jn"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Ix"></span></font></td>
					</tr>
				</table>
			...
			<td class="pe_if">
				<div id="pe_aap">
					<table class="pe_tX">
						<tr>
							<td>
								<table class="pe_dS"><tr><td class="pe_gO" colspan="3"></td></tr>
								</table>
							 
								<table class="pe_dS">
								
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_CC"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class = "pe_eS" colspan="3"></td>
									</tr>

									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ca"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Be"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ae"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<input type="text" id="ImageSavePath" class="pe_kj" name="ImageSavePath" value="<%=settingValue.get("ImageSavePath")%>" /> ex) http:// www.mysite.com/image
										</td>
									</tr>
									...
									<div id="pe_aff">
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Bc"></span></b></td>
										<td class="pe_fE"></td>
										<td >
											<table class="pe_dS">
												<tr>
													<td class="pe_eo"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_NE" value="real" /><span id="pe_Bv"></span>
												...
												<tr>
													<td class="pe_eo"> &nbsp;&nbsp;
													<input type="radio" name="encodingStyle" id="pe_aaq" value="trans" /><span id="pe_Cl"></span>
													</td>
												</tr>
												<tr>
													<td class = "pe_eS" colspan="3"></td>
												...
												<tr>
													<td class="pe_eo"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_aaU" value="random" /><span id="pe_GP"></span>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_In"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo"> &nbsp;
											<input type="hidden" id="UploadFileSubDir" name ="UploadFileSubDir" value="<%=settingValue.get("UploadFileSubDir")%>" />
											<input type="radio" id="pe_FA" name="pe_SQ" value="true" /><label for="pe_FA"><span id="pe_Io"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_FT" name="pe_SQ" value="false" /><label for="pe_FT"><span id="pe_Hw"></span></label>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_AI"></span></b></td>
										<td class="pe_fE"></td>
										<td >
											<table class="pe_dS">
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_zK"></span></td>
													<td class="pe_fE"></td>
													<td class="pe_eo"><input type="text" id="Width" name="Width" class="pe_ng" maxlength="10" value="<%=settingValue.get("Width")%>" />
													px</td>
												</tr>
												<tr>
													<td class = "pe_eS" colspan="3"></td>
												...
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_zE"></span></td>
													<td class="pe_fE"></td>
													<td class="pe_eo"><input type="text" id="Height" name="Height" class="pe_ng" maxlength="10" value="<%=settingValue.get("Height")%>" /> px
													</td>
												</tr>	
											</table>
										</td>
						...
						<tr>
							<td class="pe_mb pe_jn"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Ib"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_dS">
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GZ"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Kh"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HX"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hb"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HE"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_KB"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_IA"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_FZ"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_ID"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_BM"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<input type="text" id="DocBaseURL" name="DocBaseURL" class="pe_kj" value="<%=settingValue.get("DocBaseURL")%>" /> ex) http://www.mysite.com/doc.html 
										</td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_IY"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Nm"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_LC"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xS"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jy"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Mm"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<input type="number" min="0" max="60" style="ime-mode:disabled;" id="AutoSavePeriod" name="AutoSavePeriod" class="pe_kj" value="<%=settingValue.get("AutoSavePeriod")%>" /><b><span id="pe_FJ"></span></b>&nbsp;&nbsp;<span id="pe_LJ"></span>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jf"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
						...
						<tr>
							<td class="pe_mb pe_jn"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Iu"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_dS">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wq"><span id="pe_xo"></span></b></td>
										<td class="pe_fE"></td>
										<td>
											<table class="pe_dS">
												<input type="hidden" name="UploadImageFileExtBlockList" value="<%=settingValue.get("UploadImageFileExtBlockList")%>" />
												<tr>
													<td class="pe_eo"><input type="checkbox" id="UploadImageFileExtBlockListChecked" <%=settingValue.get("UploadImageFileExtBlockListChecked")%>/><span id="pe_nV"></span></td>
												</tr>
												<tr>
													<td class="pe_eo"><textarea id="UploadImageFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadImageFileExtBlockListTextarea")%></textarea><br /><span id="pe_zg"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_wq"></span></b></td>
										<td class="pe_fE"></td>
										<td>
											<table class="pe_dS">
												<input type="hidden" name="UploadFileExtBlockList" value="<%=settingValue.get("UploadFileExtBlockList")%>" />
												<tr>
													<td class="pe_eo"><input type="checkbox" id="UploadFileExtBlockListChecked" <%=settingValue.get("UploadFileExtBlockListChecked")%>/><span id="pe_nV"></span></td>
												</tr>
												<tr>
													<td class="pe_eo"><textarea id="UploadFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadFileExtBlockListTextarea")%></textarea><br /><span id="pe_zg"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hi"></span></b></td>
										<td class="pe_fE"></td>
										<td >
											<table class="pe_dS">
												<input type="hidden" name="AttributeBlockList" value="<%=settingValue.get("AttributeBlockList")%>" />
												<tr>
													<td class="pe_eo"><input type="checkbox" id="AttributeBlockListChecked" <%=settingValue.get("AttributeBlockListChecked")%>/><span id="pe_nV"></span></td>
												</tr>
												<tr>
													<td class="pe_eo"><textarea id="AttributeBlockListTextarea" cols="70" rows="2"><%=settingValue.get("AttributeBlockListTextarea") %></textarea><br /><span id="pe_vA"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hv"></span></b></td>
										<td class="pe_fE"></td>
										<td >
											<table class="pe_dS">
												<input type="hidden" name="TagBlockList" value="<%=settingValue.get("TagBlockList")%>" />
												<tr>
													<td class="pe_eo"><input type="checkbox" id="TagBlockListChecked" <%=settingValue.get("TagBlockListChecked")%>/><span id="pe_nV"></span></td>
												</tr>
												<tr>
													<td class="pe_eo"><textarea id="TagBlockListTextarea" cols="70" rows="2"><%=settingValue.get("TagBlockListTextarea") %></textarea><br /><span id="pe_vA"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
						...
						<tr>
							<td class="pe_mb pe_jn"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Ii"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_dS" >
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GY"></span></b></td>
										<td class="pe_fE"></td>
										<td>
											<table class="pe_dS">
												<input type="hidden" name="Template" id="Template" value="<%=settingValue.get("Template")%>" />
												<tr>
													<td class="pe_eo"><input type="button" id="pe_aCV" value="+" onClick="pe_t(this)"/></td>
													<td class="pe_eo">&nbsp;</td>
													<td class="pe_eo">&nbsp;</td>
												</tr>
												<tr style="background-color:#B2EBF4;">
													<td class="pe_eo"><b>Title</b></td>
													<td class="pe_eo"><b>URL</b></td>
													<td class="pe_eo"><b>Encoding</b></td>
												</tr>
											...
											for(int i=0; i<TemplateListArr.length ; i++){
												...
												if(TemplateListArr[i] == null || TemplateListArr[i] == ""){
													...
													%>
														<tr>
															<td><input type="text"  name="pe_Wg"  value="<%=templateName %>" style="width:100px"/></td>
															<td><input type="text"  name="pe_afv"  value="<%=templateUrl %>" style="width:320px"/></td>
															<td><input type="text"  name="pe_afX"  value="<%=templateEncoding %>" style="width:90px"/><input type="button" value="-" onclick="pe_G(this)"/></td>
					...
					<table class="pe_tX">
						<tr>
							<td>
								...
								<table class="pe_dS">
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HK"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_ST" class="color{hash:true,valueElement:'FontColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="FontColor" name="FontColor" value="<%=settingValue.get("FontColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_jB">
											<input type="button" class="pe_jg pe_gQ" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_ST').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hm"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JS"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JW"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										...
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GV"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo"><input type="checkbox" id="ReturnKeyActionBRChecked" <%=settingValue.get("ReturnKeyActionBRChecked")%>/><label for="ReturnKeyActionBR"><span id="pe_Ij"></span></label></td>
									</tr>
									<tr>
										<td class="pe_eS" colspan="3"></td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ly"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jo"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Nu"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
								...
								<table class="pe_dS">
									<tr>
										<td class="pe_mb pe_jn"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_xo"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GU"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_WN" class="color{hash:true,valueElement:'ImgLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="ImgLineColor" name="ImgLineColor" value="<%=settingValue.get("ImgLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_jB">
											<input type="button" class="pe_jg pe_gQ" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_WN').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
								...
								<table class="pe_dS">				
									<tr>
										<td class="pe_mb pe_jn"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Hh"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HL"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_Wr" class="color{hash:true,valueElement:'TableLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableLineColor" name="TableLineColor" value="<%=settingValue.get("TableLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_jB">
											<input type="button" class="pe_jg pe_gQ" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_Wr').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hf"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_Yy" class="color{hash:true,valueElement:'TableBGColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableBGColor" name="TableBGColor" value="<%=settingValue.get("TableBGColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_jB">
											<input type="button" class="pe_jg pe_gQ" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_Yy').color.fromString('#FFFFFF');">
											</li>
											</ul></td>
											</tr>
											</table>
			...
			<td class="pe_if">
				<div id="pe_acj">
					<table class="pe_tX">
						<tr>
							<td>
								...
								<table class="pe_dS">
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GT"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ki"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_CE"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<input type="text" id="Css" name="Css" class="pe_kj" value="<%=settingValue.get("Css")%>" />  ex) http://www.mysite.com/common.css 
										</td>
									</tr>
									<tr>
										<td class="pe_eS" colspan="3"></td>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HQ"></span></b>
										...
										<td >
											<table class="pe_dS">
												<tr>
													<td class="pe_tO">&nbsp;&nbsp;<span id="pe_IC"></span></td>
													<td class="pe_fE"></td>
													<td class="pe_eo">
														<input type="text" id="outlinecolor" name="outlinecolor" class="pe_uZ" value="" />  ex) #000000 or black 
													</td>
												</tr>
												<tr>
													<td class="pe_eS" colspan="3"></td>
												...
												<tr>
													<td class="pe_tO">&nbsp;&nbsp;<span id="pe_JK"></span></td>
													<td class="pe_fE"></td>
													<td class="pe_eo">
														<input type="text" id="innerlineColor" name="innerlineColor" class="pe_uZ" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_eS" colspan="3"></td>
												...
												<tr>
													<td class="pe_tO">&nbsp;&nbsp;<span id="pe_HS"></span></td>
													<td class="pe_fE"></td>
													<td class="pe_eo">
														<input type="text" id="skinfontColor" name="skinfontColor" class="pe_uZ" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_eS" colspan="3"></td>
												...
												<tr>
													<td class="pe_tO">&nbsp;&nbsp;<span id="pe_Hz"></span></td>
													<td class="pe_fE"></td>
													<td class="pe_eo">
														<input type="text" id="toolbarBackgroundColor" name="toolbarBackgroundColor" class="pe_uZ" value="" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hg"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<input type="hidden" id="CreateTab" name ="CreateTab" value="<%=settingValue.get("CreateTab")%>" />
											<input type="checkbox" id="pe_AG" name="pe_tm" value="0" /><label for="pe_AG"><span id="wysiwyg"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_Cz" name="pe_tm" value="1" /><label for="pe_Cz"><span id="html"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_Ck" name="pe_tm" value="2" /><label for="pe_Ck"><span id="preview"></span></label>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td class="pe_mb pe_jn"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_It"></span></font></td>
						</tr>
						<tr>
							<td>
								<table class="pe_dS"><tr><td class="pe_gO" colspan="3"></td></tr>
								...
								<table class="pe_dS">
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HR"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
						...
						<table class="pe_mH">
							<tr>
								<td>
									<table class="pe_dS">
										<tr>
											<td class="pe_eS" colspan="5"></td>
										</tr>
										<tr>
											<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ik"></span></b></td>
											<td class="pe_fE"></td>
											<td>
												<table class="pe_dS">
													<tr>
														<td class="pe_uD" >&nbsp;&nbsp;<span id="pe_GK"></span></td>
														<td class="pe_fE"></td>
														<td class="pe_eo">
															<input type="text" id="AdminPageUserMenuIdInput" name="AdminPageUserMenuIdInput" class="pe_kj" value="" /> 
														</td>
													</tr>
													<tr>
														<td class="pe_eS" colspan="3"></td>
													...
													<tr>
														<td class="pe_uD">&nbsp;&nbsp;<span id="pe_Ho"></span></td>
														<td class="pe_fE"></td>
														<td class="pe_eo">
															<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_Nw" value="function" /><label for="pe_Nw"><span id="pe_GX"></span></label>&nbsp;&nbsp;<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_MV" value="plugin" /><label for="pe_MV"><span id="pe_Hn"></span></label>
														</td>
													</tr>
													<tr>
														<td class="pe_eS" colspan="3"></td>
													...
													<tr>
														<td class="pe_uD">&nbsp;&nbsp;<span id="pe_HP"></span></td>
														<td class="pe_fE"></td>
														<td class="pe_eo" height="50px">
															<input type="text" id="AdminPageUserMenuButtonImgPathInput" name="AdminPageUserMenuButtonImgPathInput" class="pe_kj" value="" />
													...
													<tr>
														<td class="pe_uD">&nbsp;&nbsp;<span id="pe_Ih"></span></td>
														<td class="pe_fE"></td>
														<td class="pe_eo">	
															<input type="text" id="AdminPageUserMenuTitleInput" name="AdminPageUserMenuTitleInput" class="pe_kj" value="" />
														</td>
													</tr>
												</table>
											</td>
											<td class="pe_fE"></td>
											<td style="text-align:center;vertical-align:middle;"><input type="button" id="pe_Ax" value="" class="" style="width:60px;height:60px;"/>
											</td>
										</tr>
										<tr>
											<td class="pe_eS" colspan="5"></td>
										...
										<tr>
											<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hj"></span></b></td>
											<td class="pe_fE"></td>
											<td class="pe_eo" colspan="2">
												<div id="pe_arU">&nbsp;</div>
											</td>
										</tr>
										<tr>
					...
					<div id = "pe_dS">
						...
						<table class="pe_mH">	
							<tr>
								<td id="pe_TR" class="pe_jn">
									
									<table>
										<tr>
											<td id="pe_axU">
												<span id="pe_Ip"></span>: <br>
												<div id="pe_ahw" >
													<span id="pe_vs"></span> <br> 
													<span id="pe_CP"></span><br>
													<span id="pe_yh"></span><br>
												</div>
											</td>
											<td id="pe_atG">
											...
											<td valign="bottom">
												<ul style="margin:0 auto;width:340px;">
													<li class="pe_jB">
														<input type="button" id="spacebar" value="" class="pe_jg pe_gQ" style="width:80px;height:26px;" />
													</li>
													<li class="pe_jB"><input type="button" id="space" value="" class="pe_jg pe_gQ" style="width:68px;height:26px;"></li>
													<li class="pe_jB"><input type="button" id="enter" value="" class="pe_jg pe_gQ" style="width:66px;height:26px;"></li>
												</ul>
											</td>
										</tr>
										<tr>
							...
							<tr>
								<td>
									<table class="pe_dS">
										<tr><td class="pe_gO" colspan="3"></td></tr>
									</table>
								</td>
							</tr>
						</table>	
				
						<table id="pe_iw" class="pe_mH">
					...
					<table class="pe_tX">
						<tr>
							<td>
								...
								<table class="pe_dS">
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GW"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<input type="text" id="DocTitle" name="DocTitle" class="pe_kj" value="<%=settingValue.get("DocTitle")%>" />
										</td>
									</tr>
									<tr>
										<td class="pe_eS" colspan="3"></td>
									...
									<tr>
										<td class="pe_et">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GE"></span></b></td>
										<td class="pe_fE"></td>
										<td class="pe_eo">
											<input type="hidden" id="AccessibilityOption" name ="AccessibilityOption" value="<%=settingValue.get("AccessibilityOption")%>" />
											<input type="radio" id="pe_KG" name="pe_Dk" value="0" /><label for="pe_KG"><span id="pe_Gb"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Ld" name="pe_Dk" value="1" /><label for="pe_Ld"><span id="pe_Gr"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Lk" name="pe_Dk" value="2" /><label for="pe_Lk"><span id="pe_Gf"></span></label>
										</td>
									</tr>
									<tr>
										<td class="pe_eS" colspan="3"></td>
	...
	<tr id="pe_SZ">
		<td id="pe_Tl">
			<ul style="margin:0 auto;width:170px;">
				<li class="pe_jB">
					<input type="submit" id="pe_KE" value="" class="pe_jg pe_gQ" style="width:66px;height:26px;" />
				</li>
				<li class="pe_jB"><input type="button" id="pe_za" value="" class="pe_jg pe_gQ" style="width:66px;height:26px;"></li>
			</ul>
		</td>
	</tr>
</table>
