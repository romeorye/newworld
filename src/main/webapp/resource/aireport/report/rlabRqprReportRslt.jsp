...
class ReportHandler{
	...
	private void getScriptFromlb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet10_A23="대외비";
			sheet10_D23="#PAGE";
			sheet10_H23="연구소.고객사용안전.제품신뢰성연구PJT\n";
		}   //end if(bIsFirst)
	...
	private void getScriptFromvb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet10_H1="(주)LX하우시스 / 연구소";
			sheet10_H2="07796 서울특별시 강서구 마곡중앙10로 30";
			sheet10_H3="LG사이언스파크 LX하우시스 연구소";
			sheet10_B5="접수번호";
			sheet10_C5 = data5_acpcNo;
			sheet10_E5="페이지수";
			sheet10_G5="직접입력";
			sheet10_B6="시험제목";
			sheet10_C6 = data5_rlabNm;
			sheet10_E6="시험구분";
			sheet10_G6 = data5_rlabScnNm;
			sheet10_B7="사업부";
			sheet10_C7 = data5_upperRqprDeptNm;
			sheet10_E7="WBS Code";
			sheet10_G7 = data5_wbsCd;
			sheet10_B8="팀(PJT)";
			sheet10_C8 = data5_rqprDeptNm;
			sheet10_E8="긴급 유무";
			sheet10_G8 = data5_rlabUgyYnNm;
			sheet10_B9="의뢰자";
			sheet10_C9 = data5_rgstNm;
			sheet10_E9="시험담당자";
			sheet10_G9 = data5_rlabChrgNm;
			sheet10_B10="시료 수";
			sheet10_C10 = data5_smpoCnt;
			sheet10_E10="접수일";
			sheet10_G10 = data5_acpcDt;
			sheet10_H10="시험기간";
			sheet10_I10 = data5_rlabFrTo;
			sheet10_B11="시험결과";
			sheet10_C11 = data5_rlabRsltSbc;
			sheet10_B13="작성자";
			sheet10_C13="직접입력";
			sheet10_E13="작성일";
			sheet10_G13="직접입력";
			...
			sheet10_G15="직접입력";
			sheet10_B17="주의 :";
			sheet10_B18="이 문서는 연구정보통합시스템(IRIS)에서 조회한 경우에만 유효하며 작성자 외 시험결과 및 세부내용의 무단 수정을 금지합니다.";
			sheet10_B19="이 문서는 문서보안 규정에 따라 비밀문서로 관리되며 해당 시험 건의 의뢰자 및 의뢰팀장의 승인 없이 외부에 유출할 수 없습니다.           ";
			sheet10_B20="또한, 시험결과를 연구개발 외의 용도로 사용하기 위해서는 먼저 신뢰성연구PJT PL과 협의하시기 바랍니다.";
		}    //end if(bIsFirst)
	...
	private void getScriptFromlb2_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet20_A18="대외비";
			sheet20_E18="#PAGE";
			sheet20_H18="연구소.고객사용안전.제품신뢰성연구PJT";
		}   //end if(bIsFirst)
		...
		while(data5.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_4[0]=getPrintHeightEx(sheet20_B4, sheet20_B4_Split, charWidth, 11, 740, nYEndPos-nYCurPos-6, nAutoHeight_rb2_4[0], 10, 6, "cell_style_18");
		...
		while(data6.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_1[0]=getPrintHeightEx(sheet20_B7, sheet20_B7_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_1[0], 10, 0, "cell_style_19");
		...
		while(data7.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_2[0]=getPrintHeightEx(sheet20_B10, sheet20_B10_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_2[0], 10, 0, "cell_style_19");
		...
		while(data8.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_3[0]=getPrintHeightEx(sheet20_B13, sheet20_B13_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_3[0], 10, 0, "cell_style_19");
		...
		while(data8.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					//페이지 연결 출력 Auto Size Code
					nAutoHeight_rb2_5[0]=20;
					nAutoHeight_rb2_5[0]=getPrintHeightEx(sheet20_B16, sheet20_B16_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_5[0], 10, 0, "cell_style_19");
	...
	private void getScriptFromfoot(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet30_A7="대외비";
			sheet30_D7="#PAGE";
			sheet30_H7="연구소.고객사용안전.제품신뢰성연구PJT";
		}   //end if(bIsFirst)
	...
	private void getScriptFromlb4_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet40_A5="대외비";
			sheet40_D5="#PAGE";
			sheet40_H5="연구소.고객사용안전.제품신뢰성연구PJT";
		}   //end if(bIsFirst)
	...
	private void writeScriptlb1_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 566, 134, 18, sheet10_A23, "sheet10_A23", "cell_style_11");
		objectWrite(CELL_OBJECT, 146, 566, 195, 18, "", "sheet10_C23", "cell_style_12");
		objectWrite(CELL_OBJECT, 341, 566, 160, 18, sheet10_D23, "sheet10_D23", "cell_style_13");
		objectWrite(CELL_OBJECT, 501, 566, 20, 18, "", "sheet10_F23", "cell_style_12");
		objectWrite(CELL_OBJECT, 521, 566, 73, 18, "", "sheet10_G23", "cell_style_14");
		objectWrite(CELL_OBJECT, 594, 566, 236, 18, sheet10_H23, "sheet10_H23", "cell_style_15");
	}
	...
	private void writeScriptvb1_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_H10"), nYCurPos+mapTop.get("sheet10_H10"), mapWidth.get("sheet10_H10"), mapHeight.get("sheet10_H10"), sheet10_H10, "sheet10_H10", mapStyle.get("sheet10_H10"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_I10"), nYCurPos+mapTop.get("sheet10_I10"), mapWidth.get("sheet10_I10"), mapHeight.get("sheet10_I10"), sheet10_I10, "sheet10_I10", mapStyle.get("sheet10_I10"));
		...
		objectWrite(DRAW_OBJECT, nXCurPos+295, nYCurPos+2, 234, 49, AI_BOX_OBJ6, "AI_BOX_OBJ6", "draw_style_1");
	}

	//----fb2_1 스크립트 문 출력 함수----
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet20_B1, "sheet20_B1", "cell_style_16");
	}

	//----lb2_1 스크립트 문 출력 함수----
	private void writeScriptlb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 566, 134, 18, sheet20_A18, "sheet20_A18", "cell_style_11");
		objectWrite(CELL_OBJECT, 146, 566, 162, 18, "", "sheet20_C18", "cell_style_22");
		objectWrite(CELL_OBJECT, 308, 566, 80, 18, "", "sheet20_D18", "cell_style_22");
		objectWrite(CELL_OBJECT, 388, 566, 80, 18, sheet20_E18, "sheet20_E18", "cell_style_22");
		objectWrite(CELL_OBJECT, 468, 566, 20, 18, "", "sheet20_F18", "cell_style_22");
		objectWrite(CELL_OBJECT, 488, 566, 47, 18, "", "sheet20_G18", "cell_style_22");
		objectWrite(CELL_OBJECT, 535, 566, 295, 18, sheet20_H18, "sheet20_H18", "cell_style_23");
	}
	...
	private void writeScriptfb3_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet30_B1, "sheet30_B1", "cell_style_25");
	}

	//----foot 스크립트 문 출력 함수----
	private void writeScriptfoot( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 566, 134, 18, sheet30_A7, "sheet30_A7", "cell_style_11");
		objectWrite(CELL_OBJECT, 146, 566, 195, 18, "", "sheet30_C7", "cell_style_28");
		objectWrite(CELL_OBJECT, 341, 566, 160, 18, sheet30_D7, "sheet30_D7", "cell_style_28");
		objectWrite(CELL_OBJECT, 501, 566, 20, 18, "", "sheet30_F7", "cell_style_28");
		objectWrite(CELL_OBJECT, 521, 566, 60, 18, "", "sheet30_G7", "cell_style_28");
		objectWrite(CELL_OBJECT, 581, 566, 249, 18, sheet30_H7, "sheet30_H7", "cell_style_29");
	}
	...
	private void writeScriptfb4_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet40_B1, "sheet40_B1", "cell_style_25");
	}

	//----lb4_1 스크립트 문 출력 함수----
	private void writeScriptlb4_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 566, 134, 18, sheet40_A5, "sheet40_A5", "cell_style_11");
		objectWrite(CELL_OBJECT, 146, 566, 195, 18, "", "sheet40_C5", "cell_style_28");
		objectWrite(CELL_OBJECT, 341, 566, 160, 18, sheet40_D5, "sheet40_D5", "cell_style_28");
		objectWrite(CELL_OBJECT, 501, 566, 20, 18, "", "sheet40_F5", "cell_style_28");
		objectWrite(CELL_OBJECT, 521, 566, 60, 18, "", "sheet40_G5", "cell_style_28");
		objectWrite(CELL_OBJECT, 581, 566, 249, 18, sheet40_H5, "sheet40_H5", "cell_style_29");
	}
	...
	private void getBgImageScriptEx(int nIndex) throws Exception{
		switch(nIndex){
			...
			objectWrite(DRAW_OBJECT, 12, 12, 818, 60, "", "AI_IMAGE_OBJ2", "draw_style_2");
			break;
			case 30:		//SHEET=Sheet3   FRAME=0 배경 이미지 스크립트
			objectWrite(DRAW_OBJECT, 12, 12, 818, 60, "", "AI_IMAGE_OBJ3", "draw_style_2");
			break;
			case 40:		//SHEET=Sheet4   FRAME=0 배경 이미지 스크립트
			objectWrite(DRAW_OBJECT, 12, 12, 818, 60, "", "AI_IMAGE_OBJ4", "draw_style_2");
			break;
		}
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|30|rlabRqprReportRslt.style|보고서 (2017/10/19 10:13:51)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_H1", 582, 0, 203, 20, "cell_style_0");
		setCellInfoMap_Internal("sheet10_B10", 34, 168, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C10", 134, 168, 275, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_E10", 409, 168, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G10", 509, 168, 73, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_H10", 582, 168, 80, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_I10", 662, 168, 123, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B11", 34, 188, 100, 175, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C11", 134, 188, 651, 175, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B13", 34, 373, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C13", 134, 373, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E13", 409, 373, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G13", 509, 373, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B14", 34, 393, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C14", 134, 393, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E14", 409, 393, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G14", 509, 393, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B15", 34, 413, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C15", 134, 413, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E15", 409, 413, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G15", 509, 413, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B17", 34, 443, 751, 25, "cell_style_8");
		setCellInfoMap_Internal("sheet10_B18", 34, 468, 751, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B19", 34, 483, 751, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet10_H2", 582, 20, 203, 15, "cell_style_1");
		setCellInfoMap_Internal("sheet10_B20", 34, 498, 751, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B21", 34, 513, 751, 5, "cell_style_10");
		setCellInfoMap_Internal("sheet10_H3", 582, 35, 203, 15, "cell_style_1");
		setCellInfoMap_Internal("sheet10_B5", 34, 68, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C5", 134, 68, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E5", 409, 68, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G5", 509, 68, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B6", 34, 88, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C6", 134, 88, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E6", 409, 88, 100, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_G6", 509, 88, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B7", 34, 108, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C7", 134, 108, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E7", 409, 108, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G7", 509, 108, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B8", 34, 128, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C8", 134, 128, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E8", 409, 128, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G8", 509, 128, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B9", 34, 148, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C9", 134, 148, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E9", 409, 148, 100, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G9", 509, 148, 276, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_B10", 34, 0, 750, nAutoHeight_rb2_2[0], "cell_style_19");
		setCellInfoMap_Internal("sheet20_B11", 34, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_C11", 134, 0, 162, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_D11", 296, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_E11", 376, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_F11", 456, 0, 20, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_G11", 476, 0, 47, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_H11", 523, 0, 161, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_I11", 684, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_B12", 34, 10, 750, 22, "cell_style_17");
		setCellInfoMap_Internal("sheet20_B13", 34, 0, 750, nAutoHeight_rb2_3[0], "cell_style_19");
		setCellInfoMap_Internal("sheet20_B14", 34, 0, 100, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_C14", 134, 0, 162, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_D14", 296, 0, 80, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_E14", 376, 0, 80, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_F14", 456, 0, 20, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_G14", 476, 0, 47, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_H14", 523, 0, 161, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_I14", 684, 0, 100, 10, "cell_style_21");
		setCellInfoMap_Internal("sheet20_B15", 34, 10, 750, 22, "cell_style_17");
		setCellInfoMap_Internal("sheet20_B16", 34, 0, 750, nAutoHeight_rb2_5[0], "cell_style_19");
		setCellInfoMap_Internal("sheet20_B17", 34, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_C17", 134, 0, 162, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_D17", 296, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_E17", 376, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_F17", 456, 0, 20, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_G17", 476, 0, 47, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_H17", 523, 0, 161, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_I17", 684, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_B19", 34, 0, 750, 40, "cell_style_24");
		setCellInfoMap_Internal("sheet20_B3", 34, 0, 750, 22, "cell_style_17");
		setCellInfoMap_Internal("sheet20_B4", 34, 0, 750, nAutoHeight_rb2_4[0], "cell_style_18");
		setCellInfoMap_Internal("sheet20_B6", 34, 10, 750, 22, "cell_style_17");
		setCellInfoMap_Internal("sheet20_B7", 34, 0, 750, nAutoHeight_rb2_1[0], "cell_style_19");
		setCellInfoMap_Internal("sheet20_B8", 34, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_C8", 134, 0, 162, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_D8", 296, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_E8", 376, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_F8", 456, 0, 20, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_G8", 476, 0, 47, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_H8", 523, 0, 161, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_I8", 684, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_B9", 34, 10, 750, 22, "cell_style_17");
		setCellInfoMap_Internal("sheet30_B3", 34, 0, 100, 20, "cell_style_26");
		setCellInfoMap_Internal("sheet30_B5", 34, 0, 455, 23, "cell_style_27");
		setCellInfoMap_Internal("sheet40_B3", 34, 0, 295, 20, "cell_style_27");
	}
}
%>
