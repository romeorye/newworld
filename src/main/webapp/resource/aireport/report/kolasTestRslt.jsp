...
class ReportHandler{
	...
	private void executeSheet10( ) throws Exception{
		...
		initSheetVariant(12, 84, 584, 810, true);
	...
	private void getScriptFromfb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_D1="시험성적서";
			sheet10_B2="07796 서울특별시 강서구 마곡중앙10로 30";
			sheet10_B3=" LX사이언스파크 LX하우시스 연구소";
		}   //end if(bIsFirst)
	...
	private void getScriptFromlb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet10_A33="대외비";
			sheet10_D33="#PAGE";
			sheet10_F33="연구소.고객사용안전.무해성검증PJT";
		}   //end if(bIsFirst)
	...
	private void getScriptFromrb1_3(boolean bIsPrint) throws Exception{
		...
		while(data3.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B17 = data3_exprNm;
			sheet10_B17 = String.valueOf(cnt) + ")  " +data3_exprNm+"  /  "+data3_smpoQty+" 개";
	...
	private void getScriptFromvb1_5(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=210;    //밴드 출력 높이

		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_B19="3.  분석결과";
			sheet10_B21="※ * 표시된 시험결과는 동일 표준 내 시험기관의 인정범위 밖의 것임을 밝힙니다. ";
			sheet10_B22="※ 이 성적서의 내용은 시험의뢰인에 의해 제공된 시료에 한하며, 용도 외 사용(특히, 광고 목적의 사용)을 금합니다.\n※ 이 성적서는 전자 문서인 경우 연구정보통합시스템(IRIS)에서 열람하거나 전자보안문서인 경우에만 유효하며, 인쇄 문서인 경우\n   복사방해용지에 인쇄되었으며 작성자와 책임자의 서명 및 시험기관의 직인이 있는 경우에만 유효합니다.\n※ 이 성적서의 진위확인이 필요한 경우, 품질책임자(☎ 02-6987-7361)로 연락바랍니다.";
		}    //end if(bIsFirst)
	...
	private void getScriptFromvb1_6(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=155;    //밴드 출력 높이

		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_B23="5.  검토 및 승인";
			sheet10_B25="작성자";
			sheet10_C25="직접입력";
			sheet10_E25="작성일";
			sheet10_G25="직접입력";
			...
			sheet10_E27="승인일";
			sheet10_G27="직접입력";
			sheet10_B29="위 성적서는 국제시험기관인정협력체(International Laboratory Accreditation Cooperation) 상호인정협정(Mutual Recogn\nition Arrangement)에 서명한 한국인정기구(KOLAS)로부터 공인받은 분야에 대한 시험결과입니다";
			sheet10_C31="     한국인정기구 인정";
			sheet10_D31=" (주) LX하우시스 연구소장";
		}    //end if(bIsFirst)
	...
	private void getScriptFromlb2_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet20_A5="대외비";
			sheet20_D5="#PAGE";
			sheet20_F5="연구소.고객사용안전.무해성검증PJT";
		}   //end if(bIsFirst)
	...
	private void writeScriptfb1_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 239, 12, 125, 63, sheet10_D1, "sheet10_D1", "cell_style_0");
		objectWrite(CELL_OBJECT, 36, 54, 203, 11, sheet10_B2, "sheet10_B2", "cell_style_1");
		objectWrite(CELL_OBJECT, 36, 65, 203, 10, sheet10_B3, "sheet10_B3", "cell_style_1");
		objectWrite(DRAW_OBJECT, 56, 16, 136, 36, "", "AI_IMAGE_OBJ1", "draw_style_0");
		objectWrite(DRAW_OBJECT, 387, 14, 148, 59, "", "AI_IMAGE_OBJ3", "draw_style_1");
	}

	//----lb1_1 스크립트 문 출력 함수----
	private void writeScriptlb1_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 810, 104, 21, sheet10_A33, "sheet10_A33", "cell_style_19");
		objectWrite(CELL_OBJECT, 116, 810, 123, 21, "", "sheet10_C33", "cell_style_20");
		objectWrite(CELL_OBJECT, 239, 810, 125, 21, sheet10_D33, "sheet10_D33", "cell_style_20");
		objectWrite(CELL_OBJECT, 364, 810, 220, 21, sheet10_F33, "sheet10_F33", "cell_style_20");
	}
	...
	private void writeScriptvb1_5( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_B20"), nYCurPos+mapTop.get("sheet10_B20"), mapWidth.get("sheet10_B20"), mapHeight.get("sheet10_B20"), "", "sheet10_B20", mapStyle.get("sheet10_B20"));
	...
	private void writeScriptvb1_6( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_I24"), nYCurPos+mapTop.get("sheet10_I24"), mapWidth.get("sheet10_I24"), mapHeight.get("sheet10_I24"), "", "sheet10_I24", mapStyle.get("sheet10_I24"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C25"), nYCurPos+mapTop.get("sheet10_C25"), mapWidth.get("sheet10_C25"), mapHeight.get("sheet10_C25"), sheet10_C25, "sheet10_C25", mapStyle.get("sheet10_C25"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_E25"), nYCurPos+mapTop.get("sheet10_E25"), mapWidth.get("sheet10_E25"), mapHeight.get("sheet10_E25"), sheet10_E25, "sheet10_E25", mapStyle.get("sheet10_E25"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_E26"), nYCurPos+mapTop.get("sheet10_E26"), mapWidth.get("sheet10_E26"), mapHeight.get("sheet10_E26"), sheet10_E26, "sheet10_E26", mapStyle.get("sheet10_E26"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C31"), nYCurPos+mapTop.get("sheet10_C31"), mapWidth.get("sheet10_C31"), mapHeight.get("sheet10_C31"), sheet10_C31, "sheet10_C31", mapStyle.get("sheet10_C31"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_D31"), nYCurPos+mapTop.get("sheet10_D31"), mapWidth.get("sheet10_D31"), mapHeight.get("sheet10_D31"), sheet10_D31, "sheet10_D31", mapStyle.get("sheet10_D31"));
	}

	//----fb2_1 스크립트 문 출력 함수----
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 36, 12, 524, 60, sheet20_B1, "sheet20_B1", "cell_style_21");
	}

	//----lb2_1 스크립트 문 출력 함수----
	private void writeScriptlb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 813, 104, 18, sheet20_A5, "sheet20_A5", "cell_style_19");
		objectWrite(CELL_OBJECT, 116, 813, 107, 18, "", "sheet20_C5", "cell_style_20");
		objectWrite(CELL_OBJECT, 223, 813, 140, 18, sheet20_D5, "sheet20_D5", "cell_style_20");
		objectWrite(CELL_OBJECT, 363, 813, 221, 18, sheet20_F5, "sheet20_F5", "cell_style_20");
	}
	...
	private void getBgImageScriptEx(int nIndex) throws Exception{
		switch(nIndex){
			...
			objectWrite(DRAW_OBJECT, 12, 12, 572, 60, "", "AI_IMAGE_OBJ2", "draw_style_2");
			break;
		}
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|28|kolasTestRslt.style|보고서 (2017/10/19 10:43:46)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B10", 24, 80, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C10", 104, 80, 178, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E10", 282, 80, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G10", 362, 80, 187, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B11", 24, 100, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C11", 104, 100, 178, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E11", 282, 100, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G11", 362, 100, 187, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B13", 24, 0, 525, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_B14", 24, 0, 525, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B15", 24, 0, 80, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_C15", 104, 0, 123, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_D15", 227, 0, 55, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_E15", 282, 0, 70, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_F15", 352, 0, 10, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_G15", 362, 0, 10, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_H15", 372, 0, 70, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_I15", 442, 0, 107, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B16", 24, 15, 525, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_B17", 24, 0, 525, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B18", 24, 0, 80, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_C18", 104, 0, 123, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_D18", 227, 0, 55, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_E18", 282, 0, 70, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_F18", 352, 0, 10, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_G18", 362, 0, 10, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_H18", 372, 0, 70, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_I18", 442, 0, 107, 15, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B19", 24, 15, 525, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_B20", 24, 35, 525, 100, "cell_style_8");
		setCellInfoMap_Internal("sheet10_B21", 24, 135, 525, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B22", 24, 150, 525, 60, "cell_style_10");
		setCellInfoMap_Internal("sheet10_B23", 24, 0, 525, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet10_B24", 24, 20, 80, 1, "cell_style_12");
		setCellInfoMap_Internal("sheet10_I24", 442, 20, 107, 1, "cell_style_13");
		setCellInfoMap_Internal("sheet10_B25", 24, 21, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_C25", 104, 21, 178, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet10_E25", 282, 21, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_G25", 362, 21, 187, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet10_B26", 24, 41, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_C26", 104, 41, 178, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet10_E26", 282, 41, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_G26", 362, 41, 187, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet10_B27", 24, 61, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_C27", 104, 61, 178, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet10_E27", 282, 61, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_G27", 362, 61, 187, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet10_B29", 24, 86, 525, 30, "cell_style_16");
		setCellInfoMap_Internal("sheet10_C31", 104, 122, 123, 28, "cell_style_17");
		setCellInfoMap_Internal("sheet10_D31", 227, 122, 322, 28, "cell_style_18");
		setCellInfoMap_Internal("sheet10_B6", 24, 0, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C6", 104, 0, 178, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E6", 282, 0, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G6", 362, 0, 187, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B7", 24, 20, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C7", 104, 20, 445, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B8", 24, 40, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C8", 104, 40, 178, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E8", 282, 40, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G8", 362, 40, 187, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B9", 24, 60, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C9", 104, 60, 178, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_E9", 282, 60, 80, 20, "cell_style_2");
		setCellInfoMap_Internal("sheet10_G9", 362, 60, 187, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_B3", 24, 0, 187, 21, "cell_style_17");
	}
}
%>
