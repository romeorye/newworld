...
public void jspInit() {
	...
	sql_data1.append("	SU.SA_NAME							                AS rgstNm, ");
	...
	sql_data1.append("	dbo.fn_getUserName(ANL_CHRG_ID)						AS anlChrgNm, ");
...
class ReportHandler{
	...
	private void executeSheet20( ) throws Exception{
		//쉬트 초기화 함수 호출
		getSheetPaperInfo("A4", "2100x2970", "9", "VERTICAL", "0 0 0 0");
		initSheetVariant(12, 77, 584, 811, true);
	...
	private void getScriptFromfb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_D1="시험성적서";
			sheet10_G1="(주)LG하우시스 / 중앙연구소";
			sheet10_G2="07796 서울특별시 중앙로 강서구 마곡중앙10로 30";
			sheet10_G3="LG사이언스파크 LG하우시스 중앙연구소.분석 PJT";
		}   //end if(bIsFirst)
	...
	private void getScriptFromvb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet10_B6="접수번호";
			sheet10_C6 = data1_acpcNo;
			sheet10_E6="페이지수";
			sheet10_B7="분석명";
			sheet10_C7 = data1_anlNm;
			sheet10_B8="사업부";
			sheet10_C8 = data1_rqpUperrDeptNm;
			sheet10_E8="분석구분";
			sheet10_G8 = data1_anlScnNm;
			sheet10_B9="팀(PJT)";
			sheet10_C9 = data1_rqprDeptNm;
			sheet10_E9="긴급 유무";
			sheet10_G9 = data1_anlUgyYnNm;
			sheet10_B10="의뢰자";
			sheet10_C10 = data1_rgstNm;
			sheet10_E10="분석담당자";
			sheet10_G10 = data1_anlChrgNm;
			sheet10_B11="시료 수";
			sheet10_C11 = data1_smpoCnt;
			sheet10_E11="접수일";
			sheet10_G11 = data1_acpcDt;
		}    //end if(bIsFirst)
	...
	private void getScriptFromrb1_1(boolean bIsPrint) throws Exception{
		...
		while(data4.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B14 = data4_smpoNm;
			sheet10_B14 = String.valueOf(cnt) + ")  " +data4_smpoNm+ "  /  "+data4_mkrNm +"  /  "+data4_mdlNm;
	...
	private void getScriptFromrb1_2(boolean bIsPrint) throws Exception{
		...
		while(data2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B17 = data2_preAnlNm;
			sheet10_B17 = String.valueOf(cnt) + ")  " +data2_preAcpcNo+ " : "+data2_preAnlNm +"  /  의뢰자  :  "+data2_preRgstNm+"  /  담당자  :  "+data2_preAnlChrgNm;
	...
	private void getScriptFromvb1_7(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_B19="3.  실험 정보";
			sheet10_B20="*TVOC 실험법: 실내 공기질 공정 시험 기준_환경부 고시 제2017-11호";
		}    //end if(bIsFirst)
	...
	private void getScriptFromrb1_3(boolean bIsPrint) throws Exception{
		...
		while(data3.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B21 = data3_exprNm;
			sheet10_B21 = String.valueOf(cnt) + ")  " +data3_exprNm+"  /  "+data3_smpoQty+" 개";
	...
	private void writeScriptfb1_1( ) throws Exception{
		...
		objectWrite(DRAW_OBJECT, 37, 20, 158, 32, "", "AI_IMAGE_OBJ1", "draw_style_0");
	}

	//----lb1_1 스크립트 문 출력 함수----
	private void writeScriptlb1_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 813, 104, 18, sheet10_A32, "sheet10_A32", "cell_style_15");
		objectWrite(CELL_OBJECT, 116, 813, 337, 18, sheet10_C32, "sheet10_C32", "cell_style_16");
		objectWrite(CELL_OBJECT, 453, 813, 131, 18, sheet10_I32, "sheet10_I32", "cell_style_17");
	}
	...
	private void writeScriptvb1_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G6"), nYCurPos+mapTop.get("sheet10_G6"), mapWidth.get("sheet10_G6"), mapHeight.get("sheet10_G6"), "", "sheet10_G6", mapStyle.get("sheet10_G6"));
	...
	private void writeScriptvb1_5( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_B22"), nYCurPos+mapTop.get("sheet10_B22"), mapWidth.get("sheet10_B22"), mapHeight.get("sheet10_B22"), "", "sheet10_B22", mapStyle.get("sheet10_B22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C22"), nYCurPos+mapTop.get("sheet10_C22"), mapWidth.get("sheet10_C22"), mapHeight.get("sheet10_C22"), "", "sheet10_C22", mapStyle.get("sheet10_C22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_D22"), nYCurPos+mapTop.get("sheet10_D22"), mapWidth.get("sheet10_D22"), mapHeight.get("sheet10_D22"), "", "sheet10_D22", mapStyle.get("sheet10_D22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_E22"), nYCurPos+mapTop.get("sheet10_E22"), mapWidth.get("sheet10_E22"), mapHeight.get("sheet10_E22"), "", "sheet10_E22", mapStyle.get("sheet10_E22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_F22"), nYCurPos+mapTop.get("sheet10_F22"), mapWidth.get("sheet10_F22"), mapHeight.get("sheet10_F22"), "", "sheet10_F22", mapStyle.get("sheet10_F22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G22"), nYCurPos+mapTop.get("sheet10_G22"), mapWidth.get("sheet10_G22"), mapHeight.get("sheet10_G22"), "", "sheet10_G22", mapStyle.get("sheet10_G22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_H22"), nYCurPos+mapTop.get("sheet10_H22"), mapWidth.get("sheet10_H22"), mapHeight.get("sheet10_H22"), "", "sheet10_H22", mapStyle.get("sheet10_H22"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_I22"), nYCurPos+mapTop.get("sheet10_I22"), mapWidth.get("sheet10_I22"), mapHeight.get("sheet10_I22"), "", "sheet10_I22", mapStyle.get("sheet10_I22"));
	...
	private void writeScriptvb1_6( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_B27"), nYCurPos+mapTop.get("sheet10_B27"), mapWidth.get("sheet10_B27"), mapHeight.get("sheet10_B27"), "", "sheet10_B27", mapStyle.get("sheet10_B27"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C28"), nYCurPos+mapTop.get("sheet10_C28"), mapWidth.get("sheet10_C28"), mapHeight.get("sheet10_C28"), "", "sheet10_C28", mapStyle.get("sheet10_C28"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G28"), nYCurPos+mapTop.get("sheet10_G28"), mapWidth.get("sheet10_G28"), mapHeight.get("sheet10_G28"), "", "sheet10_G28", mapStyle.get("sheet10_G28"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C29"), nYCurPos+mapTop.get("sheet10_C29"), mapWidth.get("sheet10_C29"), mapHeight.get("sheet10_C29"), "", "sheet10_C29", mapStyle.get("sheet10_C29"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G29"), nYCurPos+mapTop.get("sheet10_G29"), mapWidth.get("sheet10_G29"), mapHeight.get("sheet10_G29"), "", "sheet10_G29", mapStyle.get("sheet10_G29"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C30"), nYCurPos+mapTop.get("sheet10_C30"), mapWidth.get("sheet10_C30"), mapHeight.get("sheet10_C30"), "", "sheet10_C30", mapStyle.get("sheet10_C30"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_E30"), nYCurPos+mapTop.get("sheet10_E30"), mapWidth.get("sheet10_E30"), mapHeight.get("sheet10_E30"), sheet10_E30, "sheet10_E30", mapStyle.get("sheet10_E30"));
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G30"), nYCurPos+mapTop.get("sheet10_G30"), mapWidth.get("sheet10_G30"), mapHeight.get("sheet10_G30"), "", "sheet10_G30", mapStyle.get("sheet10_G30"));
	}

	//----fb2_1 스크립트 문 출력 함수----
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 36, 12, 524, 60, sheet20_B1, "sheet20_B1", "cell_style_18");
	}

	//----lb2_1 스크립트 문 출력 함수----
	private void writeScriptlb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 811, 104, 20, sheet20_A3, "sheet20_A3", "cell_style_19");
		objectWrite(CELL_OBJECT, 116, 811, 337, 20, sheet20_C3, "sheet20_C3", "cell_style_20");
		objectWrite(CELL_OBJECT, 453, 811, 131, 20, sheet20_I3, "sheet20_I3", "cell_style_21");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|2|anlRqprTestRslt.style|보고서 (2017/10/19 10:43:46)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B10", 24, 80, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_C10", 104, 80, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E10", 281, 80, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_G10", 361, 80, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B11", 24, 100, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_C11", 104, 100, 177, 20, "cell_style_5");
		setCellInfoMap_Internal("sheet10_E11", 281, 100, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_G11", 361, 100, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B13", 24, 0, 524, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B14", 24, 0, 524, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B15", 24, 0, 80, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_C15", 104, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_D15", 211, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_E15", 281, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_F15", 351, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_G15", 361, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_H15", 371, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_I15", 441, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_B16", 24, 15, 524, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B17", 24, 0, 524, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B18", 24, 0, 80, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_C18", 104, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_D18", 211, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_E18", 281, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_F18", 351, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_G18", 361, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_H18", 371, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_I18", 441, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_B19", 24, 15, 524, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B20", 24, 35, 524, 20, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B21", 24, 0, 524, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B22", 24, 0, 80, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_C22", 104, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_D22", 211, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_E22", 281, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_F22", 351, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_G22", 361, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_H22", 371, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_I22", 441, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_B23", 24, 15, 524, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B24", 24, 35, 524, 100, "cell_style_10");
		setCellInfoMap_Internal("sheet10_B26", 24, 0, 524, 20, "cell_style_11");
		setCellInfoMap_Internal("sheet10_B27", 24, 20, 80, 1, "cell_style_12");
		setCellInfoMap_Internal("sheet10_I27", 441, 20, 107, 1, "cell_style_13");
		setCellInfoMap_Internal("sheet10_B28", 24, 21, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_C28", 104, 21, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E28", 281, 21, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_G28", 361, 21, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B29", 24, 41, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_C29", 104, 41, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E29", 281, 41, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_G29", 361, 41, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B30", 24, 61, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_C30", 104, 61, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E30", 281, 61, 80, 20, "cell_style_14");
		setCellInfoMap_Internal("sheet10_G30", 361, 61, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B6", 24, 0, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_C6", 104, 0, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E6", 281, 0, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_G6", 361, 0, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B7", 24, 20, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_C7", 104, 20, 444, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B8", 24, 40, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_C8", 104, 40, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E8", 281, 40, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_G8", 361, 40, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B9", 24, 60, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_C9", 104, 60, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E9", 281, 60, 80, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_G9", 361, 60, 187, 20, "cell_style_4");
	}
}
%>
