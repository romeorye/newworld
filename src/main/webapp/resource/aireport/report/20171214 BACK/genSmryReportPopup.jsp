...
class ReportHandler{
	...
	private void getScriptFromvb2_2_2(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			sheet21_B8 = data1_NPROD_SALS_PLN_Y;
			sheet21_C8 = data1_NPROD_SALS_PLN_Y_1;
			sheet21_E8 = data1_NPROD_SALS_PLN_Y_2;
			sheet21_F8 = data1_NPROD_SALS_PLN_Y_3;
			sheet21_G8 = data1_NPROD_SALS_PLN_Y_4;
			sheet21_I8=0;
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|3|getSmryReportPopup.style|보고서 (2017/10/19 10:13:51)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet21_B8", 120, 100, 48, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet21_C8", 168, 100, 48, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet21_E8", 216, 100, 48, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet21_F8", 264, 100, 48, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet21_G8", 312, 100, 48, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet21_I8", 360, 100, 48, 20, "cell_style_12");
		setCellInfoMap_Internal("sheet21_A9", 0, 120, 120, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet21_B9", 120, 120, 48, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet21_C9", 168, 120, 48, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet21_E9", 216, 120, 48, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet21_F9", 264, 120, 48, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet21_G9", 312, 120, 48, 20, "cell_style_15");
		setCellInfoMap_Internal("sheet21_I9", 360, 120, 48, 20, "cell_style_15");
	}
}
%>
