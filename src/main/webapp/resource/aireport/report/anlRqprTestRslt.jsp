...
class ReportHandler{
	...
	private void getScriptFromfb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet10_D1="시험성적서";
			sheet10_G1="(주)LX하우시스 / 연구소";
			sheet10_G2="07796 서울특별시 강서구 마곡중앙10로 30";
			sheet10_G3="LG사이언스파크 LX하우시스 연구소";
		}   //end if(bIsFirst)
	...
	private void getScriptFromrb1_3(boolean bIsPrint) throws Exception{
		...
		while(data3.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet10_B20 = data3_exprNm;
			sheet10_B20 = String.valueOf(cnt) + ")  " +data3_exprNm+"  /  "+data3_smpoQty+" 개";
	...
	private void writeScriptlb1_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 813, 104, 18, sheet10_A31, "sheet10_A31", "cell_style_14");
		objectWrite(CELL_OBJECT, 116, 813, 107, 18, "", "sheet10_C31", "cell_style_15");
		objectWrite(CELL_OBJECT, 223, 813, 160, 18, sheet10_D31, "sheet10_D31", "cell_style_15");
		objectWrite(CELL_OBJECT, 383, 813, 177, 18, sheet10_H31, "sheet10_H31", "cell_style_15");
		objectWrite(CELL_OBJECT, 560, 813, 24, 18, "", "sheet10_J31", "cell_style_16");
	}
	...
	private void writeScriptvb1_5( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_B23"), nYCurPos+mapTop.get("sheet10_B23"), mapWidth.get("sheet10_B23"), mapHeight.get("sheet10_B23"), "", "sheet10_B23", mapStyle.get("sheet10_B23"));
	}
	...
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 36, 12, 524, 60, sheet20_B1, "sheet20_B1", "cell_style_17");
	}
	...
	private void writeScriptlb2_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 223, 813, 150, 18, sheet20_D5, "sheet20_D5", "cell_style_20");
		objectWrite(CELL_OBJECT, 373, 813, 211, 18, sheet20_G5, "sheet20_G5", "cell_style_20");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|12|anlRqprTestRslt.style|보고서 (2017/10/19 10:43:46)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_B20", 24, 0, 524, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B21", 24, 0, 80, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_C21", 104, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_D21", 211, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_E21", 281, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_F21", 351, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_G21", 361, 0, 10, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_H21", 371, 0, 70, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_I21", 441, 0, 107, 15, "cell_style_8");
		setCellInfoMap_Internal("sheet10_B22", 24, 15, 524, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_B23", 24, 35, 524, 100, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B25", 24, 0, 524, 20, "cell_style_10");
		setCellInfoMap_Internal("sheet10_B26", 24, 20, 80, 1, "cell_style_11");
		setCellInfoMap_Internal("sheet10_I26", 441, 20, 107, 1, "cell_style_12");
		setCellInfoMap_Internal("sheet10_B27", 24, 21, 80, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet10_C27", 104, 21, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E27", 281, 21, 80, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet10_G27", 361, 21, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B28", 24, 41, 80, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet10_C28", 104, 41, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E28", 281, 41, 80, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet10_G28", 361, 41, 187, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_B29", 24, 61, 80, 20, "cell_style_13");
		setCellInfoMap_Internal("sheet10_C29", 104, 61, 177, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_E29", 281, 61, 80, 20, "cell_style_13");
		...
		setCellInfoMap_Internal("sheet20_B3", 24, 0, 187, 21, "cell_style_18");
	}
}
%>
