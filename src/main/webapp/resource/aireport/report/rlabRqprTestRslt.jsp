...
class ReportHandler{
	...
	private void getScriptFromvb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		//폰트 사이즈 : 10
		//각 문자별 폭을 할당할 배열 선언
		int[] charWidth = {280,246,410,576,576,796,661,226,358,358,484,619,198,402,200,391,619,619,619,619,619,619,619,619,619,619,200,200,619,619,619,450,1096,673,627,642,683,581,541,696,713,244,367,606,503,877,740,703,605,703,626,572,542,683,615,1014,642,602,587,367,902,367,491,464,576,510,547,473,549,519,358,548,549,223,223,505,230,835,549,557,547,548,374,462,400,548,477,768,499,481,485,384,220,384,507,891};
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			nAutoHeight_vb1_1[5]=getPrintHeight(sheet10_K11, charWidth, 10, 67, 20, nAutoHeight_vb1_1[5], 10, 0, "cell_style_8");
	...
	private void writeScriptlb1_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 373, 813, 211, 18, sheet10_G31, "sheet10_G31", "cell_style_23");
	}
	...
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 36, 12, 524, 60, sheet20_B1, "sheet20_B1", "cell_style_24");
	}

	//----lb2_1 스크립트 문 출력 함수----
	private void writeScriptlb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 813, 104, 18, sheet20_A5, "sheet20_A5", "cell_style_26");
		objectWrite(CELL_OBJECT, 116, 813, 107, 18, "", "sheet20_C5", "cell_style_27");
		objectWrite(CELL_OBJECT, 223, 813, 140, 18, sheet20_D5, "sheet20_D5", "cell_style_27");
		objectWrite(CELL_OBJECT, 363, 813, 10, 18, "", "sheet20_F5", "cell_style_27");
		objectWrite(CELL_OBJECT, 373, 813, 211, 18, sheet20_G5, "sheet20_G5", "cell_style_27");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|14|rlabRqprTestRslt.style|보고서 (2017/10/19 10:43:46)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_B3", 24, 0, 187, 21, "cell_style_25");
	}
}
%>
