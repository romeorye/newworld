...
class ReportHandler{
	...
	private void getScriptFromvb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet10_G2="      (주)LG하우시스 / 연구소";
			sheet10_G3="            07796 서울특별시 강서구 마곡중앙10로 30";
			sheet10_G4="                LG사이언스파크 LG하우시스 연구소";
			sheet10_B6="접수번호";
		...
		while(data5.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_4[0]=getPrintHeightEx(sheet20_B4, sheet20_B4_Split, charWidth, 11, 536, nYEndPos-nYCurPos-6, nAutoHeight_rb2_4[0], 10, 6, "cell_style_16");
		...
		while(data6.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_1[0]=getPrintHeightEx(sheet20_B7, sheet20_B7_Split, charWidth, 11, 536, nYEndPos-nYCurPos-0, nAutoHeight_rb2_1[0], 10, 0, "cell_style_17");
		...
		while(data7.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_2[0]=getPrintHeightEx(sheet20_B10, sheet20_B10_Split, charWidth, 11, 536, nYEndPos-nYCurPos-0, nAutoHeight_rb2_2[0], 10, 0, "cell_style_17");
		...
		while(data8.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_3[0]=getPrintHeightEx(sheet20_B13, sheet20_B13_Split, charWidth, 11, 536, nYEndPos-nYCurPos-0, nAutoHeight_rb2_3[0], 10, 0, "cell_style_17");
		...
		while(data8.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_5[0]=getPrintHeightEx(sheet20_B16, sheet20_B16_Split, charWidth, 11, 536, nYEndPos-nYCurPos-0, nAutoHeight_rb2_5[0], 10, 0, "cell_style_20");
	...
	private void writeScriptlb1_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 361, 823, 234, 18, sheet10_G26, "sheet10_G26", "cell_style_13");
	}
	...
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 24, 0, 546, 60, sheet20_B1, "sheet20_B1", "cell_style_14");
	}
	...
	private void writeScriptlb2_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 82, 823, 135, 18, "", "sheet20_C18", "cell_style_21");
		objectWrite(CELL_OBJECT, 217, 823, 150, 18, sheet20_D18, "sheet20_D18", "cell_style_21");
		objectWrite(CELL_OBJECT, 367, 823, 227, 18, sheet20_G18, "sheet20_G18", "cell_style_21");
	}
	...
	private void writeScriptfb3_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 24, 0, 546, 60, sheet30_B1, "sheet30_B1", "cell_style_23");
	}
	...
	private void writeScriptfb4_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 24, 0, 546, 60, sheet40_B1, "sheet40_B1", "cell_style_23");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|25|rlabRqprReportRslt_new.style|보고서 (2017/10/19 10:13:51)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_B10", 24, 0, 546, nAutoHeight_rb2_2[0], "cell_style_17");
		setCellInfoMap_Internal("sheet20_B11", 24, 0, 58, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_C11", 82, 0, 135, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_D11", 217, 0, 80, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_E11", 297, 0, 50, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_F11", 347, 0, 20, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_G11", 367, 0, 50, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_H11", 417, 0, 60, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_I11", 477, 0, 93, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_B12", 24, 10, 546, 22, "cell_style_15");
		setCellInfoMap_Internal("sheet20_B13", 24, 0, 546, nAutoHeight_rb2_3[0], "cell_style_17");
		setCellInfoMap_Internal("sheet20_B14", 24, 0, 58, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_C14", 82, 0, 135, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_D14", 217, 0, 80, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_E14", 297, 0, 50, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_F14", 347, 0, 20, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_G14", 367, 0, 50, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_H14", 417, 0, 60, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_I14", 477, 0, 93, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_B15", 24, 10, 546, 22, "cell_style_15");
		setCellInfoMap_Internal("sheet20_B16", 24, 0, 546, nAutoHeight_rb2_5[0], "cell_style_20");
		setCellInfoMap_Internal("sheet20_B17", 24, 0, 58, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_C17", 82, 0, 135, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_D17", 217, 0, 80, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_E17", 297, 0, 50, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_F17", 347, 0, 20, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_G17", 367, 0, 50, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_H17", 417, 0, 60, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_I17", 477, 0, 93, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_B19", 24, 0, 546, 40, "cell_style_22");
		setCellInfoMap_Internal("sheet20_B3", 24, 0, 546, 22, "cell_style_15");
		setCellInfoMap_Internal("sheet20_B4", 24, 0, 546, nAutoHeight_rb2_4[0], "cell_style_16");
		setCellInfoMap_Internal("sheet20_B6", 24, 10, 546, 22, "cell_style_15");
		setCellInfoMap_Internal("sheet20_B7", 24, 0, 546, nAutoHeight_rb2_1[0], "cell_style_17");
		setCellInfoMap_Internal("sheet20_B8", 24, 0, 58, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_C8", 82, 0, 135, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_D8", 217, 0, 80, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_E8", 297, 0, 50, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_F8", 347, 0, 20, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_G8", 367, 0, 50, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_H8", 417, 0, 60, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_I8", 477, 0, 93, 10, "cell_style_18");
		setCellInfoMap_Internal("sheet20_B9", 24, 10, 546, 22, "cell_style_15");
		setCellInfoMap_Internal("sheet30_B3", 24, 0, 193, 22, "cell_style_24");
		setCellInfoMap_Internal("sheet30_B5", 24, 0, 323, 23, "cell_style_25");
		setCellInfoMap_Internal("sheet40_B3", 24, 0, 193, 22, "cell_style_25");
	}
}
%>
