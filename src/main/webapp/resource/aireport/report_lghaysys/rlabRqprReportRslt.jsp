...
class ReportHandler{
		...
		while(data5.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_4[0]=getPrintHeightEx(sheet20_B4, sheet20_B4_Split, charWidth, 11, 740, nYEndPos-nYCurPos-6, nAutoHeight_rb2_4[0], 10, 6, "cell_style_17");
		...
		while(data6.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_1[0]=getPrintHeightEx(sheet20_B7, sheet20_B7_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_1[0], 10, 0, "cell_style_18");
		...
		while(data7.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_2[0]=getPrintHeightEx(sheet20_B10, sheet20_B10_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_2[0], 10, 0, "cell_style_18");
		...
		while(data8.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_3[0]=getPrintHeightEx(sheet20_B13, sheet20_B13_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_3[0], 10, 0, "cell_style_18");
		...
		while(data8.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_5[0]=getPrintHeightEx(sheet20_B16, sheet20_B16_Split, charWidth, 11, 740, nYEndPos-nYCurPos-0, nAutoHeight_rb2_5[0], 10, 0, "cell_style_18");
	...
	private void writeScriptlb1_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 341, 566, 160, 18, sheet10_D23, "sheet10_D23", "cell_style_12");
		objectWrite(CELL_OBJECT, 501, 566, 20, 18, "", "sheet10_F23", "cell_style_12");
		objectWrite(CELL_OBJECT, 521, 566, 60, 18, "", "sheet10_G23", "cell_style_13");
		objectWrite(CELL_OBJECT, 581, 566, 249, 18, sheet10_H23, "sheet10_H23", "cell_style_14");
	}
	...
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet20_B1, "sheet20_B1", "cell_style_15");
	}
	...
	private void writeScriptlb2_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 146, 566, 162, 18, "", "sheet20_C18", "cell_style_21");
		objectWrite(CELL_OBJECT, 308, 566, 80, 18, "", "sheet20_D18", "cell_style_21");
		objectWrite(CELL_OBJECT, 388, 566, 80, 18, sheet20_E18, "sheet20_E18", "cell_style_21");
		objectWrite(CELL_OBJECT, 468, 566, 20, 18, "", "sheet20_F18", "cell_style_21");
		objectWrite(CELL_OBJECT, 488, 566, 47, 18, "", "sheet20_G18", "cell_style_21");
		objectWrite(CELL_OBJECT, 535, 566, 295, 18, sheet20_H18, "sheet20_H18", "cell_style_22");
	}
	...
	private void writeScriptfb3_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet30_B1, "sheet30_B1", "cell_style_24");
	}
	...
	private void writeScriptfoot( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 146, 566, 195, 18, "", "sheet30_C7", "cell_style_27");
		objectWrite(CELL_OBJECT, 341, 566, 160, 18, sheet30_D7, "sheet30_D7", "cell_style_27");
		objectWrite(CELL_OBJECT, 501, 566, 20, 18, "", "sheet30_F7", "cell_style_27");
		objectWrite(CELL_OBJECT, 521, 566, 60, 18, "", "sheet30_G7", "cell_style_27");
		objectWrite(CELL_OBJECT, 581, 566, 249, 18, sheet30_H7, "sheet30_H7", "cell_style_28");
	}
	...
	private void writeScriptfb4_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet40_B1, "sheet40_B1", "cell_style_24");
	}
	...
	private void writeScriptlb4_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 146, 566, 195, 18, "", "sheet40_C5", "cell_style_27");
		objectWrite(CELL_OBJECT, 341, 566, 160, 18, sheet40_D5, "sheet40_D5", "cell_style_27");
		objectWrite(CELL_OBJECT, 501, 566, 20, 18, "", "sheet40_F5", "cell_style_27");
		objectWrite(CELL_OBJECT, 521, 566, 60, 18, "", "sheet40_G5", "cell_style_27");
		objectWrite(CELL_OBJECT, 581, 566, 249, 18, sheet40_H5, "sheet40_H5", "cell_style_28");
	}
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|25|rlabRqprReportRslt.style|보고서 (2017/10/19 10:13:51)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet10_H1", 569, 0, 215, 20, "cell_style_0");
		...
		setCellInfoMap_Internal("sheet10_G10", 509, 168, 60, 20, "cell_style_6");
		setCellInfoMap_Internal("sheet10_H10", 569, 168, 80, 20, "cell_style_4");
		setCellInfoMap_Internal("sheet10_I10", 649, 168, 135, 20, "cell_style_7");
		setCellInfoMap_Internal("sheet10_B11", 34, 188, 100, 175, "cell_style_2");
		setCellInfoMap_Internal("sheet10_C11", 134, 188, 650, 175, "cell_style_3");
		...
		setCellInfoMap_Internal("sheet10_G13", 509, 373, 275, 20, "cell_style_3");
		...
		setCellInfoMap_Internal("sheet10_G14", 509, 393, 275, 20, "cell_style_3");
		...
		setCellInfoMap_Internal("sheet10_G15", 509, 413, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet10_B17", 34, 443, 750, 25, "cell_style_8");
		setCellInfoMap_Internal("sheet10_B18", 34, 468, 750, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B19", 34, 483, 750, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet10_H2", 569, 20, 215, 15, "cell_style_1");
		setCellInfoMap_Internal("sheet10_B20", 34, 498, 750, 15, "cell_style_9");
		setCellInfoMap_Internal("sheet10_B21", 34, 513, 750, 5, "cell_style_10");
		setCellInfoMap_Internal("sheet10_H3", 569, 35, 215, 15, "cell_style_1");
		...
		setCellInfoMap_Internal("sheet10_G5", 509, 68, 275, 20, "cell_style_3");
		...
		setCellInfoMap_Internal("sheet10_G6", 509, 88, 275, 20, "cell_style_3");
		...
		setCellInfoMap_Internal("sheet10_G7", 509, 108, 275, 20, "cell_style_3");
		...
		setCellInfoMap_Internal("sheet10_G8", 509, 128, 275, 20, "cell_style_3");
		...
		setCellInfoMap_Internal("sheet10_G9", 509, 148, 275, 20, "cell_style_3");
		setCellInfoMap_Internal("sheet20_B10", 34, 0, 750, nAutoHeight_rb2_2[0], "cell_style_18");
		setCellInfoMap_Internal("sheet20_B11", 34, 0, 100, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_C11", 134, 0, 162, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_D11", 296, 0, 80, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_E11", 376, 0, 80, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_F11", 456, 0, 20, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_G11", 476, 0, 47, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_H11", 523, 0, 161, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_I11", 684, 0, 100, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_B12", 34, 10, 750, 22, "cell_style_16");
		setCellInfoMap_Internal("sheet20_B13", 34, 0, 750, nAutoHeight_rb2_3[0], "cell_style_18");
		setCellInfoMap_Internal("sheet20_B14", 34, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_C14", 134, 0, 162, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_D14", 296, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_E14", 376, 0, 80, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_F14", 456, 0, 20, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_G14", 476, 0, 47, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_H14", 523, 0, 161, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_I14", 684, 0, 100, 10, "cell_style_20");
		setCellInfoMap_Internal("sheet20_B15", 34, 10, 750, 22, "cell_style_16");
		setCellInfoMap_Internal("sheet20_B16", 34, 0, 750, nAutoHeight_rb2_5[0], "cell_style_18");
		setCellInfoMap_Internal("sheet20_B17", 34, 0, 100, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_C17", 134, 0, 162, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_D17", 296, 0, 80, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_E17", 376, 0, 80, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_F17", 456, 0, 20, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_G17", 476, 0, 47, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_H17", 523, 0, 161, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_I17", 684, 0, 100, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_B19", 34, 0, 750, 40, "cell_style_23");
		setCellInfoMap_Internal("sheet20_B3", 34, 0, 750, 22, "cell_style_16");
		setCellInfoMap_Internal("sheet20_B4", 34, 0, 750, nAutoHeight_rb2_4[0], "cell_style_17");
		setCellInfoMap_Internal("sheet20_B6", 34, 10, 750, 22, "cell_style_16");
		setCellInfoMap_Internal("sheet20_B7", 34, 0, 750, nAutoHeight_rb2_1[0], "cell_style_18");
		setCellInfoMap_Internal("sheet20_B8", 34, 0, 100, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_C8", 134, 0, 162, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_D8", 296, 0, 80, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_E8", 376, 0, 80, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_F8", 456, 0, 20, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_G8", 476, 0, 47, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_H8", 523, 0, 161, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_I8", 684, 0, 100, 10, "cell_style_19");
		setCellInfoMap_Internal("sheet20_B9", 34, 10, 750, 22, "cell_style_16");
		setCellInfoMap_Internal("sheet30_B3", 34, 0, 100, 20, "cell_style_25");
		setCellInfoMap_Internal("sheet30_B5", 34, 0, 455, 23, "cell_style_26");
		setCellInfoMap_Internal("sheet40_B3", 34, 0, 295, 20, "cell_style_26");
	}
}
%>
