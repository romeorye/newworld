...
class ReportHandler{
	...
	private void executeSheet20( ) throws Exception{
		//쉬트 초기화 함수 호출
		getSheetPaperInfo("A4", "2100x2970", "9", "HORIZONTAL", "0 0 0 0");
		initSheetVariant(12, 77, 831, 564, true);
	...
	private void executeSheet30( ) throws Exception{
		//쉬트 초기화 함수 호출
		getSheetPaperInfo("A4", "2100x2970", "9", "HORIZONTAL", "0 0 0 0");
		initSheetVariant(12, 77, 831, 561, true);
		...
		getScriptFromlb3_1(true, true);    //바닥글 밴드 호출
		getScriptFromvb3_1(true, true);    //Void 밴드 호출
	...
	private void getScriptFromvb1_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		...
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			...
			//데이터 변수 할당
			sheet10_D1="분석결과서";
			sheet10_H1="(주)LG하우시스 / 중앙연구소";
			sheet10_H2="07796 서울특별시 중앙로 강서구 마곡중앙10로 30";
			sheet10_H3="LG사이언스파크 LG하우시스 중앙연구소.분석PJT";
			sheet10_B5="접수번호";
			...
			sheet10_B20="또한, 분석결과를 연구개발 외의 용도로 사용하기 위해서는 먼저 분석PJT PL과 협의하시기 바랍니다.";
		}    //end if(bIsFirst)
	...
	private void getScriptFromrb2_4(boolean bIsPrint) throws Exception{
		...
		while(data1.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			//데이터 변수 할당
			sheet20_B4=manager.scriptObject.HtmlDataParsing(751, 25, "cell_style_14", data1_anlSbc, "sheet20_B4");
		...
		while(data4.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_1[0]=getPrintHeightEx(sheet20_B7, sheet20_B7_Split, charWidth, 11, 741, nYEndPos-nYCurPos-0, nAutoHeight_rb2_1[0], 10, 0, "cell_style_15");
		...
		while(data2.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_2[0]=getPrintHeightEx(sheet20_B10, sheet20_B10_Split, charWidth, 11, 741, nYEndPos-nYCurPos-0, nAutoHeight_rb2_2[0], 10, 0, "cell_style_15");
		...
		while(data3.next()){   //자동으로 생성되는 반복 밴드의 루프문
			...
			if(bIsPrint){   //감추기 속성이 지정되지 않으면 bIsPrint는 true
				...
				do{
					...
					nAutoHeight_rb2_3[0]=getPrintHeightEx(sheet20_B13, sheet20_B13_Split, charWidth, 11, 741, nYEndPos-nYCurPos-0, nAutoHeight_rb2_3[0], 10, 0, "cell_style_15");
	...
	//----lb3_1 FooterBand Start----
	//----소속 쉬트 : SHEET=Sheet3    FRAME=Frame0
	//----밴드 이름 : lb3_1
	//----밴드 종류 : 바닥글 밴드
	//----bIsFrist : 쉬트 함수에서 최초로 호출될 때 true, 페이지 스킵 함수에서 호출될 때 false
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	private void getScriptFromlb3_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		if(bIsFirst){   //밴드 최초 호출 시에만 실행되는 코드
			//데이터 변수 할당
			sheet30_A5="비밀";
			sheet30_C5="#PAGE";
			sheet30_I5="중앙연구소 / 분석PJT";
		}   //end if(bIsFirst)
	...
	//----bIsPrint : 감추기 속성 설정 여부. true면 출력, false면 AI 스크립트를 생성하지 않음.
	//----nRepeatCnt : 부모 반복 밴드 수행 횟수와 연동 옵션 설정시 void 밴드가 수행할 반복 횟수 전달
	private void getScriptFromvb3_1(boolean bIsFirst, boolean bIsPrint) throws Exception{
		//지역 변수 선언 및 초기화
		int nBandHeight=25;    //밴드 출력 높이
	...
	private void writeScriptlb1_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, 146, 566, 550, 18, sheet10_C23, "sheet10_C23", "cell_style_10");
		objectWrite(CELL_OBJECT, 696, 566, 134, 18, sheet10_I23, "sheet10_I23", "cell_style_11");
	}
	...
	private void writeScriptvb1_1( ) throws Exception{
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G5"), nYCurPos+mapTop.get("sheet10_G5"), mapWidth.get("sheet10_G5"), mapHeight.get("sheet10_G5"), "", "sheet10_G5", mapStyle.get("sheet10_G5"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C13"), nYCurPos+mapTop.get("sheet10_C13"), mapWidth.get("sheet10_C13"), mapHeight.get("sheet10_C13"), "", "sheet10_C13", mapStyle.get("sheet10_C13"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G13"), nYCurPos+mapTop.get("sheet10_G13"), mapWidth.get("sheet10_G13"), mapHeight.get("sheet10_G13"), "", "sheet10_G13", mapStyle.get("sheet10_G13"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_C14"), nYCurPos+mapTop.get("sheet10_C14"), mapWidth.get("sheet10_C14"), mapHeight.get("sheet10_C14"), "", "sheet10_C14", mapStyle.get("sheet10_C14"));
		...
		objectWrite(CELL_OBJECT, nXCurPos+mapLeft.get("sheet10_G14"), nYCurPos+mapTop.get("sheet10_G14"), mapWidth.get("sheet10_G14"), mapHeight.get("sheet10_G14"), "", "sheet10_G14", mapStyle.get("sheet10_G14"));
		...
		objectWrite(DRAW_OBJECT, nXCurPos+35, nYCurPos+4, 198, 41, "", "AI_IMAGE_OBJ1", "draw_style_0");
	}

	//----fb2_1 스크립트 문 출력 함수----
	private void writeScriptfb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 751, 60, sheet20_B1, "sheet20_B1", "cell_style_12");
	}

	//----lb2_1 스크립트 문 출력 함수----
	private void writeScriptlb2_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 564, 134, 20, sheet20_A15, "sheet20_A15", "cell_style_17");
		objectWrite(CELL_OBJECT, 146, 564, 561, 20, sheet20_C15, "sheet20_C15", "cell_style_18");
		objectWrite(CELL_OBJECT, 707, 564, 124, 20, sheet20_I15, "sheet20_I15", "cell_style_19");
	}
	...
	private void writeScriptfb3_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet30_B1, "sheet30_B1", "cell_style_21");
	}

	//----lb3_1 스크립트 문 출력 함수----
	private void writeScriptlb3_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 566, 134, 18, sheet30_A5, "sheet30_A5", "cell_style_9");
		objectWrite(CELL_OBJECT, 146, 566, 550, 18, sheet30_C5, "sheet30_C5", "cell_style_10");
		objectWrite(CELL_OBJECT, 696, 566, 134, 18, sheet30_I5, "sheet30_I5", "cell_style_11");
	}

	//----vb3_1 스크립트 문 출력 함수----
	private void writeScriptvb3_1( ) throws Exception{
		//스크립트문 생성
	...
	private void writeScriptfb4_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 46, 12, 750, 60, sheet40_B1, "sheet40_B1", "cell_style_21");
	}

	//----lb4_1 스크립트 문 출력 함수----
	private void writeScriptlb4_1( ) throws Exception{
		//스크립트문 생성
		objectWrite(CELL_OBJECT, 12, 566, 134, 18, sheet40_A4, "sheet40_A4", "cell_style_9");
		objectWrite(CELL_OBJECT, 146, 566, 550, 18, sheet40_C4, "sheet40_C4", "cell_style_10");
		objectWrite(CELL_OBJECT, 696, 566, 134, 18, sheet40_I4, "sheet40_I4", "cell_style_11");
	}

	private void getBgImageScriptEx(int nIndex) throws Exception{
		switch(nIndex){
			case 20:		//SHEET=Sheet2   FRAME=0 배경 이미지 스크립트
			objectWrite(DRAW_OBJECT, 14, 12, 817, 60, "", "AI_IMAGE_OBJ2", "draw_style_1");
			break;
			case 30:		//SHEET=Sheet3   FRAME=0 배경 이미지 스크립트
			objectWrite(DRAW_OBJECT, 12, 13, 818, 60, "", "AI_IMAGE_OBJ3", "draw_style_1");
			break;
			case 40:		//SHEET=Sheet4   FRAME=0 배경 이미지 스크립트
			objectWrite(DRAW_OBJECT, 12, 12, 819, 60, "", "AI_IMAGE_OBJ4", "draw_style_1");
			break;
		}
	}
	...
	private void pageSkip(int nIndex) throws Exception{
		...
		switch(nIndex){
			...
			getScriptFromlb3_1(false, true);		//바닥글 밴드 호출
			break;
	...
	private void getScriptHeader(String paper, String size, String value, String orient, String margin) throws Exception{
		...
		manager.scriptWrite("AIReport", "scriptVersion|docVersion|style|title", "32|2|anlRqprReportRslt.style|보고서 (2017/10/19 10:13:51)", false);
	}
	...
	public void setCellInfoMap() throws Exception {
		...
		setCellInfoMap_Internal("sheet20_B10", 34, 0, 751, nAutoHeight_rb2_2[0], "cell_style_15");
		setCellInfoMap_Internal("sheet20_B11", 34, 0, 100, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_C11", 134, 0, 162, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_D11", 296, 0, 80, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_E11", 376, 0, 80, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_F11", 456, 0, 20, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_G11", 476, 0, 47, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_H11", 523, 0, 172, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_I11", 695, 0, 90, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_B12", 34, 10, 751, 22, "cell_style_13");
		setCellInfoMap_Internal("sheet20_B13", 34, 0, 751, nAutoHeight_rb2_3[0], "cell_style_15");
		setCellInfoMap_Internal("sheet20_B14", 34, 0, 100, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_C14", 134, 0, 162, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_D14", 296, 0, 80, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_E14", 376, 0, 80, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_F14", 456, 0, 20, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_G14", 476, 0, 47, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_H14", 523, 0, 172, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_I14", 695, 0, 90, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_B16", 34, 0, 751, 40, "cell_style_20");
		setCellInfoMap_Internal("sheet20_B3", 34, 0, 751, 22, "cell_style_13");
		setCellInfoMap_Internal("sheet20_B4", 34, 0, 751, nAutoHeight_rb2_4[0], "cell_style_14");
		setCellInfoMap_Internal("sheet20_B6", 34, 10, 751, 22, "cell_style_13");
		setCellInfoMap_Internal("sheet20_B7", 34, 0, 751, nAutoHeight_rb2_1[0], "cell_style_15");
		setCellInfoMap_Internal("sheet20_B8", 34, 0, 100, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_C8", 134, 0, 162, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_D8", 296, 0, 80, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_E8", 376, 0, 80, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_F8", 456, 0, 20, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_G8", 476, 0, 47, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_H8", 523, 0, 172, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_I8", 695, 0, 90, 10, "cell_style_16");
		setCellInfoMap_Internal("sheet20_B9", 34, 10, 751, 22, "cell_style_13");
		setCellInfoMap_Internal("sheet30_B3", 34, 0, 100, 25, "cell_style_22");
	}
}
%>
